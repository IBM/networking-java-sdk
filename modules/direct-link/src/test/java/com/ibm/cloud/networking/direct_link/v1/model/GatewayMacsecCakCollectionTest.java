...
/**
 * Unit test class for the GatewayMacsecCakCollection model.
 */
public class GatewayMacsecCakCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGatewayMacsecCakCollection() throws Throwable {
    GatewayMacsecCakCollection gatewayMacsecCakCollectionModel = new GatewayMacsecCakCollection();
    assertNull(gatewayMacsecCakCollectionModel.getCaks());
  }
}
 ...
 */
public class UpdateGatewayImportRouteFilterOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateGatewayImportRouteFilterOptions instance.
     *
     * @param updateGatewayImportRouteFilterOptions the instance to initialize the Builder with
     */
    private Builder(UpdateGatewayImportRouteFilterOptions updateGatewayImportRouteFilterOptions) {
      this.gatewayId = updateGatewayImportRouteFilterOptions.gatewayId;
      this.id = updateGatewayImportRouteFilterOptions.id;
      this.updateRouteFilterTemplatePatch = updateGatewayImportRouteFilterOptions.updateRouteFilterTemplatePatch;
    }
    ...
    /**
     * Builds a UpdateGatewayImportRouteFilterOptions.
     *
     * @return the new UpdateGatewayImportRouteFilterOptions instance
     */
    public UpdateGatewayImportRouteFilterOptions build() {
      return new UpdateGatewayImportRouteFilterOptions(this);
    }
     ...
     *
     * @param gatewayId the gatewayId
     * @return the UpdateGatewayImportRouteFilterOptions builder
     */
  ...
  protected UpdateGatewayImportRouteFilterOptions() { }

  protected UpdateGatewayImportRouteFilterOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a UpdateGatewayImportRouteFilterOptions builder
   */

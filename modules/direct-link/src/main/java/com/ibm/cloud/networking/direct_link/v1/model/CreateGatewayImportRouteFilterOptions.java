 ...
 */
public class CreateGatewayImportRouteFilterOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing CreateGatewayImportRouteFilterOptions instance.
     *
     * @param createGatewayImportRouteFilterOptions the instance to initialize the Builder with
     */
    private Builder(CreateGatewayImportRouteFilterOptions createGatewayImportRouteFilterOptions) {
      this.gatewayId = createGatewayImportRouteFilterOptions.gatewayId;
      this.action = createGatewayImportRouteFilterOptions.action;
      this.prefix = createGatewayImportRouteFilterOptions.prefix;
      this.before = createGatewayImportRouteFilterOptions.before;
      this.ge = createGatewayImportRouteFilterOptions.ge;
      this.le = createGatewayImportRouteFilterOptions.le;
    }
    ...
    /**
     * Builds a CreateGatewayImportRouteFilterOptions.
     *
     * @return the new CreateGatewayImportRouteFilterOptions instance
     */
    public CreateGatewayImportRouteFilterOptions build() {
      return new CreateGatewayImportRouteFilterOptions(this);
    }
     ...
     *
     * @param gatewayId the gatewayId
     * @return the CreateGatewayImportRouteFilterOptions builder
     */
  ...
  protected CreateGatewayImportRouteFilterOptions() { }

  protected CreateGatewayImportRouteFilterOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a CreateGatewayImportRouteFilterOptions builder
   */

 ...
 */
public class GetAlertPolicyRespResultMechanisms extends GenericModel {

  protected List<GetAlertPolicyRespResultMechanismsEmailItem> email;
  protected List<GetAlertPolicyRespResultMechanismsWebhooksItem> webhooks;

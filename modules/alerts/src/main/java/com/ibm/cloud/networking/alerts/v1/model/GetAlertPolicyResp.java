 ...
 */
public class GetAlertPolicyResp extends GenericModel {

  protected Boolean success;
  protected List<GetAlertPolicyRespErrorsItem> errors;
  protected List<GetAlertPolicyRespMessagesItem> messages;
  protected GetAlertPolicyRespResult result;

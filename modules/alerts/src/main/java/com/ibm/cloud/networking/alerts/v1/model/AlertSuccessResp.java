 ...
 */
public class AlertSuccessResp extends GenericModel {

  protected Boolean success;
  protected List<AlertSuccessRespErrorsItem> errors;
  protected List<AlertSuccessRespMessagesItem> messages;
  protected AlertSuccessRespResult result;

...
/**
 * Unit test class for the GetAlertPolicyResp model.
 */
public class GetAlertPolicyRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAlertPolicyResp() throws Throwable {
    GetAlertPolicyResp getAlertPolicyRespModel = new GetAlertPolicyResp();
    assertNull(getAlertPolicyRespModel.isSuccess());
    assertNull(getAlertPolicyRespModel.getErrors());
    assertNull(getAlertPolicyRespModel.getMessages());
    assertNull(getAlertPolicyRespModel.getResult());
  }
}
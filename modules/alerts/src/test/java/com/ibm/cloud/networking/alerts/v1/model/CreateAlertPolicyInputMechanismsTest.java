...
/**
 * Unit test class for the CreateAlertPolicyInputMechanisms model.
 */
public class CreateAlertPolicyInputMechanismsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateAlertPolicyInputMechanisms() throws Throwable {
    ...
    String json = TestUtilities.serialize(createAlertPolicyInputMechanismsModel);

    CreateAlertPolicyInputMechanisms createAlertPolicyInputMechanismsModelNew = TestUtilities.deserialize(json, CreateAlertPolicyInputMechanisms.class);
    assertTrue(createAlertPolicyInputMechanismsModelNew instanceof CreateAlertPolicyInputMechanisms);
  }
}
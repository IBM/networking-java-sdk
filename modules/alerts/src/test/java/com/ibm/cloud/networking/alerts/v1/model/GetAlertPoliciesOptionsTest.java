...
/**
 * Unit test class for the GetAlertPoliciesOptions model.
 */
public class GetAlertPoliciesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAlertPoliciesOptions() throws Throwable {
    GetAlertPoliciesOptions getAlertPoliciesOptionsModel = new GetAlertPoliciesOptions();
    assertNotNull(getAlertPoliciesOptionsModel);
  }
}
...
/**
 * Unit test class for the AlertSuccessResp model.
 */
public class AlertSuccessRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAlertSuccessResp() throws Throwable {
    AlertSuccessResp alertSuccessRespModel = new AlertSuccessResp();
    assertNull(alertSuccessRespModel.isSuccess());
    assertNull(alertSuccessRespModel.getErrors());
    assertNull(alertSuccessRespModel.getMessages());
    assertNull(alertSuccessRespModel.getResult());
  }
}
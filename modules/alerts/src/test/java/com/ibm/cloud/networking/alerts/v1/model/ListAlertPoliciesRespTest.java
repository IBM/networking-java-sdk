...
/**
 * Unit test class for the ListAlertPoliciesResp model.
 */
public class ListAlertPoliciesRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListAlertPoliciesResp() throws Throwable {
    ListAlertPoliciesResp listAlertPoliciesRespModel = new ListAlertPoliciesResp();
    assertNull(listAlertPoliciesRespModel.isSuccess());
    assertNull(listAlertPoliciesRespModel.getErrors());
    assertNull(listAlertPoliciesRespModel.getMessages());
    assertNull(listAlertPoliciesRespModel.getResult());
  }
}
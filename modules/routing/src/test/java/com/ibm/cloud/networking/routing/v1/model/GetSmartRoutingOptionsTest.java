...
/**
 * Unit test class for the GetSmartRoutingOptions model.
 */
public class GetSmartRoutingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetSmartRoutingOptions() throws Throwable {
    GetSmartRoutingOptions getSmartRoutingOptionsModel = new GetSmartRoutingOptions();
    assertNotNull(getSmartRoutingOptionsModel);
  }
}
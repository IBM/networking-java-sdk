...
/**
 * Integration test class for the Routing service.
 */
public class RoutingIT extends SdkIntegrationTestBase {
  public Routing service = null;
  ...
  public void constructService() {
    ...
    try {
      service = Routing.newInstance(crn, zoneIdentifier, serviceName);
    } catch (Exception e) {
  ...
  @Test
  public void testGetSmartRouting() throws Exception {
    try {
      ...
      assertNotNull(smartRoutingRespResult);
  ...
  @Test
  public void testUpdateSmartRouting() throws Exception {
    try {

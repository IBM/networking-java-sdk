...
/**
 * Unit test class for the UpdateSmartRoutingOptions model.
 */
public class UpdateSmartRoutingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateSmartRoutingOptions() throws Throwable {
    UpdateSmartRoutingOptions updateSmartRoutingOptionsModel = new UpdateSmartRoutingOptions.Builder()
      .value("off")
      .build();
    assertEquals(updateSmartRoutingOptionsModel.value(), "off");
  }
}
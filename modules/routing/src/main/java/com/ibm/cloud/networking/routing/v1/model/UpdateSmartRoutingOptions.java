...
public class UpdateSmartRoutingOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a UpdateSmartRoutingOptions.
     *
     * @return the new UpdateSmartRoutingOptions instance
     */
     ...
     * @return the UpdateSmartRoutingOptions builder
     */
   ...
   * New builder.
   *
   * @return a UpdateSmartRoutingOptions builder
   */

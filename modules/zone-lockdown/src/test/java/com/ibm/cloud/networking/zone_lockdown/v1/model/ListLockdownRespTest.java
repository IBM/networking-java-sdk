...
/**
 * Unit test class for the ListLockdownResp model.
 */
public class ListLockdownRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListLockdownResp() throws Throwable {
    ListLockdownResp listLockdownRespModel = new ListLockdownResp();
    assertNull(listLockdownRespModel.isSuccess());
    assertNull(listLockdownRespModel.getErrors());
    assertNull(listLockdownRespModel.getMessages());
    assertNull(listLockdownRespModel.getResult());
    assertNull(listLockdownRespModel.getResultInfo());
  }
}
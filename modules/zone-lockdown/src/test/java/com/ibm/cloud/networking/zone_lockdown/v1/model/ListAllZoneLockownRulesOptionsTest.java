...
/**
 * Unit test class for the ListAllZoneLockownRulesOptions model.
 */
public class ListAllZoneLockownRulesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListAllZoneLockownRulesOptions() throws Throwable {
    ListAllZoneLockownRulesOptions listAllZoneLockownRulesOptionsModel = new ListAllZoneLockownRulesOptions.Builder()
      ...
      .build();
    assertEquals(listAllZoneLockownRulesOptionsModel.page(), Long.valueOf("26"));
    assertEquals(listAllZoneLockownRulesOptionsModel.perPage(), Long.valueOf("5"));
  }
}
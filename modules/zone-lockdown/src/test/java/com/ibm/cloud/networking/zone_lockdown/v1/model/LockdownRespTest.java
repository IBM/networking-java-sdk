...
/**
 * Unit test class for the LockdownResp model.
 */
public class LockdownRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testLockdownResp() throws Throwable {
    LockdownResp lockdownRespModel = new LockdownResp();
    assertNull(lockdownRespModel.isSuccess());
    assertNull(lockdownRespModel.getErrors());
    assertNull(lockdownRespModel.getMessages());
    assertNull(lockdownRespModel.getResult());
  }
}
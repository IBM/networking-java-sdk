...
/**
 * The listAllZoneAccessRules options.
 */
public class ListAllZoneAccessRulesOptions extends GenericModel {
  ...
  public interface Order {
    ...
    String CONFIGURATION_TARGET = "configuration.target";
    /** configuration.value. */
    String CONFIGURATION_VALUE = "configuration.value";
    /** mode. */
    String MODE = "mode";
  }
  ...
  public static class Builder {
    ...
    private Builder(ListAllZoneAccessRulesOptions listAllZoneAccessRulesOptions) {
      this.notes = listAllZoneAccessRulesOptions.notes;
      this.mode = listAllZoneAccessRulesOptions.mode;
      this.configurationTarget = listAllZoneAccessRulesOptions.configurationTarget;
      this.configurationValue = listAllZoneAccessRulesOptions.configurationValue;
      this.page = listAllZoneAccessRulesOptions.page;
      this.perPage = listAllZoneAccessRulesOptions.perPage;
      this.order = listAllZoneAccessRulesOptions.order;
      this.direction = listAllZoneAccessRulesOptions.direction;
      this.match = listAllZoneAccessRulesOptions.match;
    }
    ...
    /**
     * Builds a ListAllZoneAccessRulesOptions.
     *
     * @return the new ListAllZoneAccessRulesOptions instance
     */
    public ListAllZoneAccessRulesOptions build() {
      return new ListAllZoneAccessRulesOptions(this);
    }
     ...
     * @return the ListAllZoneAccessRulesOptions builder
     */
  ...
  protected ListAllZoneAccessRulesOptions(Builder builder) {
    notes = builder.notes;
    mode = builder.mode;
   ...
   * New builder.
   *
   * @return a ListAllZoneAccessRulesOptions builder
   */

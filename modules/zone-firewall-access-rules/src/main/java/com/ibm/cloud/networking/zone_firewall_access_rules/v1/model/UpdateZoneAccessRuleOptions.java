...
/**
 * The updateZoneAccessRule options.
 */
public class UpdateZoneAccessRuleOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(UpdateZoneAccessRuleOptions updateZoneAccessRuleOptions) {
      this.accessruleIdentifier = updateZoneAccessRuleOptions.accessruleIdentifier;
      this.mode = updateZoneAccessRuleOptions.mode;
      this.notes = updateZoneAccessRuleOptions.notes;
    }
    ...
    /**
     * Builds a UpdateZoneAccessRuleOptions.
     *
     * @return the new UpdateZoneAccessRuleOptions instance
     */
    public UpdateZoneAccessRuleOptions build() {
      return new UpdateZoneAccessRuleOptions(this);
    }
     ...
     *
     * @param accessruleIdentifier the accessruleIdentifier
     * @return the UpdateZoneAccessRuleOptions builder
     */
  ...
  protected UpdateZoneAccessRuleOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a UpdateZoneAccessRuleOptions builder
   */

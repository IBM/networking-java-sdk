 ...
 */
public class DeleteZoneAccessRuleResp extends GenericModel {

  protected Boolean success;
  protected List<List<String>> errors;
  protected List<List<String>> messages;
  protected DeleteZoneAccessRuleRespResult result;
   ...
   * @return the result
   */
  public DeleteZoneAccessRuleRespResult getResult() {
    return result;
  }
}

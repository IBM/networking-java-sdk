...
/**
 * Unit test class for the GetZoneAccessRuleOptions model.
 */
public class GetZoneAccessRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetZoneAccessRuleOptions() throws Throwable {
    GetZoneAccessRuleOptions getZoneAccessRuleOptionsModel = new GetZoneAccessRuleOptions.Builder()
      ...
      .build();
    assertEquals(getZoneAccessRuleOptionsModel.accessruleIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetZoneAccessRuleOptionsError() throws Throwable {
    new GetZoneAccessRuleOptions.Builder().build();
  }

...
/**
 * Unit test class for the ListZoneAccessRulesResp model.
 */
public class ListZoneAccessRulesRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListZoneAccessRulesResp() throws Throwable {
    ListZoneAccessRulesResp listZoneAccessRulesRespModel = new ListZoneAccessRulesResp();
    assertNull(listZoneAccessRulesRespModel.isSuccess());
    assertNull(listZoneAccessRulesRespModel.getErrors());
    assertNull(listZoneAccessRulesRespModel.getMessages());
    assertNull(listZoneAccessRulesRespModel.getResult());
    assertNull(listZoneAccessRulesRespModel.getResultInfo());
  }
}
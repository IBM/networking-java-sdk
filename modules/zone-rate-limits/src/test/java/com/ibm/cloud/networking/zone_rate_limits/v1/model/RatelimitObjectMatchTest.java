...
/**
 * Unit test class for the RatelimitObjectMatch model.
 */
public class RatelimitObjectMatchTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRatelimitObjectMatch() throws Throwable {
    RatelimitObjectMatch ratelimitObjectMatchModel = new RatelimitObjectMatch();
    assertNull(ratelimitObjectMatchModel.getRequest());
    assertNull(ratelimitObjectMatchModel.getResponse());
  }
}
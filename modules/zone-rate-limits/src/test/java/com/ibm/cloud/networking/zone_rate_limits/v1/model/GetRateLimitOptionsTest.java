...
/**
 * Unit test class for the GetRateLimitOptions model.
 */
public class GetRateLimitOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetRateLimitOptions() throws Throwable {
    GetRateLimitOptions getRateLimitOptionsModel = new GetRateLimitOptions.Builder()
      .rateLimitIdentifier("testString")
      .build();
    assertEquals(getRateLimitOptionsModel.rateLimitIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetRateLimitOptionsError() throws Throwable {
    new GetRateLimitOptions.Builder().build();
  }

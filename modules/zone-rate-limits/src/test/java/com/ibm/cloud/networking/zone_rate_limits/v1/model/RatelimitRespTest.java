...
/**
 * Unit test class for the RatelimitResp model.
 */
public class RatelimitRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRatelimitResp() throws Throwable {
    RatelimitResp ratelimitRespModel = new RatelimitResp();
    assertNull(ratelimitRespModel.isSuccess());
    assertNull(ratelimitRespModel.getErrors());
    assertNull(ratelimitRespModel.getMessages());
    assertNull(ratelimitRespModel.getResult());
  }
}
...
/**
 * Unit test class for the RatelimitInputMatchRequest model.
 */
public class RatelimitInputMatchRequestTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRatelimitInputMatchRequest() throws Throwable {
    ...
    String json = TestUtilities.serialize(ratelimitInputMatchRequestModel);

    RatelimitInputMatchRequest ratelimitInputMatchRequestModelNew = TestUtilities.deserialize(json, RatelimitInputMatchRequest.class);
    assertTrue(ratelimitInputMatchRequestModelNew instanceof RatelimitInputMatchRequest);
    assertEquals(ratelimitInputMatchRequestModelNew.url(), "*.example.org/path*");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testRatelimitInputMatchRequestError() throws Throwable {
    new RatelimitInputMatchRequest.Builder().build();
  }

...
/**
 * Unit test class for the RatelimitObject model.
 */
public class RatelimitObjectTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRatelimitObject() throws Throwable {
    RatelimitObject ratelimitObjectModel = new RatelimitObject();
    assertNull(ratelimitObjectModel.getId());
    assertNull(ratelimitObjectModel.isDisabled());
    assertNull(ratelimitObjectModel.getDescription());
    assertNull(ratelimitObjectModel.getBypass());
    assertNull(ratelimitObjectModel.getThreshold());
    assertNull(ratelimitObjectModel.getPeriod());
    assertNull(ratelimitObjectModel.getCorrelate());
    assertNull(ratelimitObjectModel.getAction());
    assertNull(ratelimitObjectModel.getMatch());
  }
}
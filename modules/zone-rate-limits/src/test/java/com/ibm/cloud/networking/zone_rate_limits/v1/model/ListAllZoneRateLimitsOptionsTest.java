...
/**
 * Unit test class for the ListAllZoneRateLimitsOptions model.
 */
public class ListAllZoneRateLimitsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListAllZoneRateLimitsOptions() throws Throwable {
    ListAllZoneRateLimitsOptions listAllZoneRateLimitsOptionsModel = new ListAllZoneRateLimitsOptions.Builder()
      ...
      .build();
    assertEquals(listAllZoneRateLimitsOptionsModel.page(), Long.valueOf("26"));
    assertEquals(listAllZoneRateLimitsOptionsModel.perPage(), Long.valueOf("5"));
  }
}
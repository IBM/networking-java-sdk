...
/**
 * Unit test class for the ListRatelimitResp model.
 */
public class ListRatelimitRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListRatelimitResp() throws Throwable {
    ListRatelimitResp listRatelimitRespModel = new ListRatelimitResp();
    assertNull(listRatelimitRespModel.isSuccess());
    assertNull(listRatelimitRespModel.getErrors());
    assertNull(listRatelimitRespModel.getMessages());
    assertNull(listRatelimitRespModel.getResult());
    assertNull(listRatelimitRespModel.getResultInfo());
  }
}
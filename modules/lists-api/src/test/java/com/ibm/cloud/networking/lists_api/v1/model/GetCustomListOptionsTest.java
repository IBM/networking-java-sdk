...
/**
 * Unit test class for the GetCustomListOptions model.
 */
public class GetCustomListOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetCustomListOptions() throws Throwable {
    GetCustomListOptions getCustomListOptionsModel = new GetCustomListOptions();
    assertNotNull(getCustomListOptionsModel);
  }
}
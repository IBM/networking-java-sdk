...
/**
 * Unit test class for the CreateListItemsOptions model.
 */
public class CreateListItemsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateListItemsOptions() throws Throwable {
    ...
    CreateListItemsOptions createListItemsOptionsModel = new CreateListItemsOptions.Builder()
      ...
      .build();
    assertEquals(createListItemsOptionsModel.createListItemsReqItem(), java.util.Arrays.asList(createListItemsReqItemModel));
  }
}
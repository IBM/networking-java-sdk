...
/**
 * Unit test class for the GetManagedListsOptions model.
 */
public class GetManagedListsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetManagedListsOptions() throws Throwable {
    GetManagedListsOptions getManagedListsOptionsModel = new GetManagedListsOptions();
    assertNotNull(getManagedListsOptionsModel);
  }
}
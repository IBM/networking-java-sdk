...
/**
 * Unit test class for the ListCursor model.
 */
public class ListCursorTest {
  ...
  @Test
  public void testListCursor() throws Throwable {
    ListCursor listCursorModel = new ListCursor();
    assertNull(listCursorModel.getAfter());
    assertNull(listCursorModel.getBefore());
  }
}
...
/**
 * Unit test class for the GetListItemOptions model.
 */
public class GetListItemOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetListItemOptions() throws Throwable {
    GetListItemOptions getListItemOptionsModel = new GetListItemOptions();
    assertNotNull(getListItemOptionsModel);
  }
}
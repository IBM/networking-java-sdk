...
/**
 * Unit test class for the UpdateCustomListOptions model.
 */
public class UpdateCustomListOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateCustomListOptions() throws Throwable {
    UpdateCustomListOptions updateCustomListOptionsModel = new UpdateCustomListOptions.Builder()
      .description("testString")
      .build();
    assertEquals(updateCustomListOptionsModel.description(), "testString");
  }
}
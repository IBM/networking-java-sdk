...
/**
 * Unit test class for the GetOperationStatusOptions model.
 */
public class GetOperationStatusOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetOperationStatusOptions() throws Throwable {
    GetOperationStatusOptions getOperationStatusOptionsModel = new GetOperationStatusOptions();
    assertNotNull(getOperationStatusOptionsModel);
  }
}
...
/**
 * Unit test class for the DeleteCustomListOptions model.
 */
public class DeleteCustomListOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteCustomListOptions() throws Throwable {
    DeleteCustomListOptions deleteCustomListOptionsModel = new DeleteCustomListOptions();
    assertNotNull(deleteCustomListOptionsModel);
  }
}
...
/**
 * Unit test class for the GetCustomListsOptions model.
 */
public class GetCustomListsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetCustomListsOptions() throws Throwable {
    GetCustomListsOptions getCustomListsOptionsModel = new GetCustomListsOptions();
    assertNotNull(getCustomListsOptionsModel);
  }
}
...
/**
 * The createListItems options.
 */
public class CreateListItemsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing CreateListItemsOptions instance.
     *
     * @param createListItemsOptions the instance to initialize the Builder with
     */
    private Builder(CreateListItemsOptions createListItemsOptions) {
      this.createListItemsReqItem = createListItemsOptions.createListItemsReqItem;
    }
    ...
    /**
     * Builds a CreateListItemsOptions.
     *
     * @return the new CreateListItemsOptions instance
     */
    public CreateListItemsOptions build() {
      return new CreateListItemsOptions(this);
    }
     ...
     * @return the CreateListItemsOptions builder
     */
  ...
  protected CreateListItemsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a CreateListItemsOptions builder
   */

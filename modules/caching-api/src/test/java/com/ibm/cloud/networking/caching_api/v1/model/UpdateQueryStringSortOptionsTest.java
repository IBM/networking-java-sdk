...
/**
 * Unit test class for the UpdateQueryStringSortOptions model.
 */
public class UpdateQueryStringSortOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateQueryStringSortOptions() throws Throwable {
    UpdateQueryStringSortOptions updateQueryStringSortOptionsModel = new UpdateQueryStringSortOptions.Builder()
      .value("off")
      .build();
    assertEquals(updateQueryStringSortOptionsModel.value(), "off");
  }
}
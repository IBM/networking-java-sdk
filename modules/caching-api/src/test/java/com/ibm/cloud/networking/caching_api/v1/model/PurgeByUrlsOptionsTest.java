...
/**
 * Unit test class for the PurgeByUrlsOptions model.
 */
public class PurgeByUrlsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPurgeByUrlsOptions() throws Throwable {
    PurgeByUrlsOptions purgeByUrlsOptionsModel = new PurgeByUrlsOptions.Builder()
      ...
      .build();
    assertEquals(purgeByUrlsOptionsModel.files(), new java.util.ArrayList<String>(java.util.Arrays.asList("http://www.example.com/cat_picture.jpg")));
  }
}
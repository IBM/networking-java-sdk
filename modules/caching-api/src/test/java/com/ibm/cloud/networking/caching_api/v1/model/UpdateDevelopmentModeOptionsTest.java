...
/**
 * Unit test class for the UpdateDevelopmentModeOptions model.
 */
public class UpdateDevelopmentModeOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateDevelopmentModeOptions() throws Throwable {
    UpdateDevelopmentModeOptions updateDevelopmentModeOptionsModel = new UpdateDevelopmentModeOptions.Builder()
      .value("off")
      .build();
    assertEquals(updateDevelopmentModeOptionsModel.value(), "off");
  }
}
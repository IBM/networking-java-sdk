...
/**
 * Unit test class for the PurgeAllOptions model.
 */
public class PurgeAllOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPurgeAllOptions() throws Throwable {
    PurgeAllOptions purgeAllOptionsModel = new PurgeAllOptions();
    assertNotNull(purgeAllOptionsModel);
  }
}
...
/**
 * Unit test class for the GetDevelopmentModeOptions model.
 */
public class GetDevelopmentModeOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetDevelopmentModeOptions() throws Throwable {
    GetDevelopmentModeOptions getDevelopmentModeOptionsModel = new GetDevelopmentModeOptions();
    assertNotNull(getDevelopmentModeOptionsModel);
  }
}
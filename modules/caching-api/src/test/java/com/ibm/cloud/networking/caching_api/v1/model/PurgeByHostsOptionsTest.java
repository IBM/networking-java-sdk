...
/**
 * Unit test class for the PurgeByHostsOptions model.
 */
public class PurgeByHostsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPurgeByHostsOptions() throws Throwable {
    PurgeByHostsOptions purgeByHostsOptionsModel = new PurgeByHostsOptions.Builder()
      ...
      .build();
    assertEquals(purgeByHostsOptionsModel.hosts(), new java.util.ArrayList<String>(java.util.Arrays.asList("www.example.com")));
  }
}
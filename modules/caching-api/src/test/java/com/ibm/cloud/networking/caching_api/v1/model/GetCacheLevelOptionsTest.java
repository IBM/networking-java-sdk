...
/**
 * Unit test class for the GetCacheLevelOptions model.
 */
public class GetCacheLevelOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetCacheLevelOptions() throws Throwable {
    GetCacheLevelOptions getCacheLevelOptionsModel = new GetCacheLevelOptions();
    assertNotNull(getCacheLevelOptionsModel);
  }
}
...
/**
 * Unit test class for the UpdateCacheLevelOptions model.
 */
public class UpdateCacheLevelOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateCacheLevelOptions() throws Throwable {
    UpdateCacheLevelOptions updateCacheLevelOptionsModel = new UpdateCacheLevelOptions.Builder()
      .value("aggressive")
      .build();
    assertEquals(updateCacheLevelOptionsModel.value(), "aggressive");
  }
}
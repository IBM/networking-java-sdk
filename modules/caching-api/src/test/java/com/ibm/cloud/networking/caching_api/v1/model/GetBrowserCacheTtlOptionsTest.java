...
/**
 * Unit test class for the GetBrowserCacheTtlOptions model.
 */
public class GetBrowserCacheTtlOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetBrowserCacheTtlOptions() throws Throwable {
    GetBrowserCacheTtlOptions getBrowserCacheTtlOptionsModel = new GetBrowserCacheTtlOptions();
    assertNotNull(getBrowserCacheTtlOptionsModel);
  }
}
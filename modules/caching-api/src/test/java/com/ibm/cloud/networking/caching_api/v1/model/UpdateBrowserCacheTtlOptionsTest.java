...
/**
 * Unit test class for the UpdateBrowserCacheTtlOptions model.
 */
public class UpdateBrowserCacheTtlOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateBrowserCacheTtlOptions() throws Throwable {
    UpdateBrowserCacheTtlOptions updateBrowserCacheTtlOptionsModel = new UpdateBrowserCacheTtlOptions.Builder()
      ...
      .build();
    assertEquals(updateBrowserCacheTtlOptionsModel.value(), Long.valueOf("14400"));
  }
}
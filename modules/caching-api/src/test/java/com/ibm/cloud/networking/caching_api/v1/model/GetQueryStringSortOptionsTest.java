...
/**
 * Unit test class for the GetQueryStringSortOptions model.
 */
public class GetQueryStringSortOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetQueryStringSortOptions() throws Throwable {
    GetQueryStringSortOptions getQueryStringSortOptionsModel = new GetQueryStringSortOptions();
    assertNotNull(getQueryStringSortOptionsModel);
  }
}
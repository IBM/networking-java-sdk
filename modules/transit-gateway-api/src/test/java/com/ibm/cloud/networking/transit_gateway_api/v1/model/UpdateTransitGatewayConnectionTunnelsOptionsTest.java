...
/**
 * Unit test class for the UpdateTransitGatewayConnectionTunnelsOptions model.
 */
public class UpdateTransitGatewayConnectionTunnelsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateTransitGatewayConnectionTunnelsOptions() throws Throwable {
  ...
  public void testUpdateTransitGatewayConnectionTunnelsOptionsError() throws Throwable {
    new UpdateTransitGatewayConnectionTunnelsOptions.Builder().build();
  }

...
public class TransitGatewaysPager {
   ...
   * @param client the TransitGatewayApi instance to be used to invoke the "listTransitGateways" method
   * @param options the ListTransitGatewaysOptions instance to be used to invoke the "listTransitGateways" method
   */
  public TransitGatewaysPager(TransitGatewayApi client, ListTransitGatewaysOptions options) {

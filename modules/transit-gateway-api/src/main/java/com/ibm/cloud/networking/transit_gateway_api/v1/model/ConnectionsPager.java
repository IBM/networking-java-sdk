...
public class ConnectionsPager {
   ...
   * @param client the TransitGatewayApi instance to be used to invoke the "listConnections" method
   * @param options the ListConnectionsOptions instance to be used to invoke the "listConnections" method
   */
  public ConnectionsPager(TransitGatewayApi client, ListConnectionsOptions options) {

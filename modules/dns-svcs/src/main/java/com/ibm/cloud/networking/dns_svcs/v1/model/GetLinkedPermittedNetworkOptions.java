...
public class GetLinkedPermittedNetworkOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetLinkedPermittedNetworkOptions instance.
     *
     * @param getLinkedPermittedNetworkOptions the instance to initialize the Builder with
     */
    private Builder(GetLinkedPermittedNetworkOptions getLinkedPermittedNetworkOptions) {
      ...
      this.linkedDnszoneId = getLinkedPermittedNetworkOptions.linkedDnszoneId;
  ...
  protected GetLinkedPermittedNetworkOptions() { }

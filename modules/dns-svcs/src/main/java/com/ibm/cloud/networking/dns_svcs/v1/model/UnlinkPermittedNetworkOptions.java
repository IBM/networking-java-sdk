...
/**
 * The unlinkPermittedNetwork options.
 */
public class UnlinkPermittedNetworkOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(UnlinkPermittedNetworkOptions unlinkPermittedNetworkOptions) {
      this.instanceId = unlinkPermittedNetworkOptions.instanceId;
      this.lzId = unlinkPermittedNetworkOptions.lzId;
      this.permittedNetworkId = unlinkPermittedNetworkOptions.permittedNetworkId;
      this.xCorrelationId = unlinkPermittedNetworkOptions.xCorrelationId;
    }
    ...
    /**
     * Builds a UnlinkPermittedNetworkOptions.
     *
     * @return the new UnlinkPermittedNetworkOptions instance
     */
    public UnlinkPermittedNetworkOptions build() {
      return new UnlinkPermittedNetworkOptions(this);
    }
     ...
     *
     * @param instanceId the instanceId
     * @return the UnlinkPermittedNetworkOptions builder
     */
  ...
  protected UnlinkPermittedNetworkOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a UnlinkPermittedNetworkOptions builder
   */

...
public class DeleteLinkedZoneOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteLinkedZoneOptions instance.
     *
     * @param deleteLinkedZoneOptions the instance to initialize the Builder with
     */
    private Builder(DeleteLinkedZoneOptions deleteLinkedZoneOptions) {
      this.instanceId = deleteLinkedZoneOptions.instanceId;
      this.linkedDnszoneId = deleteLinkedZoneOptions.linkedDnszoneId;
  ...
  protected DeleteLinkedZoneOptions() { }

 ...
 */
public class LinkedDnszonesList extends GenericModel {

  @SerializedName("linked_dnszones")
  protected List<LinkedDnszone> linkedDnszones;
  ...
  protected LinkedDnszonesList() { }

  /**
   * Gets the linkedDnszones.
   *
   * The list of linked zones.
   *
   * @return the linkedDnszones
   */
  public List<LinkedDnszone> getLinkedDnszones() {
    return linkedDnszones;
  }

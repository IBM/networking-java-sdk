 ...
 */
public class ListForwardingRulesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a ListForwardingRulesOptions.
     *
     * @return the new ListForwardingRulesOptions instance
     */
    public ListForwardingRulesOptions build() {
      return new ListForwardingRulesOptions(this);
    }
   ...
   * New builder.
   *
   * @return a ListForwardingRulesOptions builder
   */

...
public class GetPoolOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetPoolOptions instance.
     *
     * @param getPoolOptions the instance to initialize the Builder with
     */

 ...
 */
public class SecondaryZoneList extends GenericModel {

  @SerializedName("secondary_zones")
  protected List<SecondaryZone> secondaryZones;
  ...
  protected SecondaryZoneList() { }

  /**
   * Gets the secondaryZones.
   *
   * Secondary zones.
   *
   * @return the secondaryZones
   */
  public List<SecondaryZone> getSecondaryZones() {

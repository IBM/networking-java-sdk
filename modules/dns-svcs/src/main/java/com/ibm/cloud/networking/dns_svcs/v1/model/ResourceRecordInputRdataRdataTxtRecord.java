...
public class ResourceRecordInputRdataRdataTxtRecord extends ResourceRecordInputRdata {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ResourceRecordInputRdataRdataTxtRecord instance.
     *
     * @param resourceRecordInputRdataRdataTxtRecord the instance to initialize the Builder with
     */
  ...
  protected ResourceRecordInputRdataRdataTxtRecord() { }

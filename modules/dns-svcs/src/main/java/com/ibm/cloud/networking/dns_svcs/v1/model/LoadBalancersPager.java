...
public class LoadBalancersPager {
   ...
   * @param client the DnsSvcs instance to be used to invoke the "listLoadBalancers" method
   * @param options the ListLoadBalancersOptions instance to be used to invoke the "listLoadBalancers" method
   */
  public LoadBalancersPager(DnsSvcs client, ListLoadBalancersOptions options) {
  ...
  public List<LoadBalancer> getNext() {
    ...
    ListLoadBalancers result = client.listLoadBalancers(options).execute().getResult();

...
public class PermittedNetworkVpc extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing PermittedNetworkVpc instance.
     *
     * @param permittedNetworkVpc the instance to initialize the Builder with
     */

 ...
 */
public class LinkedZonesList extends GenericModel {

  @SerializedName("linked_zones")
  protected List<LinkedZone> linkedZones;
  ...
  /**
   * Gets the linkedZones.
   *
   * The list of linked zones.
   *
   * @return the linkedZones
   */
  public List<LinkedZone> getLinkedZones() {
    return linkedZones;
  }

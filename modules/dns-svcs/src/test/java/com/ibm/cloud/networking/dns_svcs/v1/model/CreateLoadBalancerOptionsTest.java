...
public class CreateLoadBalancerOptionsTest {
  ...
  public void testCreateLoadBalancerOptions() throws Throwable {
    ...
    assertEquals(createLoadBalancerOptionsModel.defaultPools(), java.util.Arrays.asList("24ccf79a-4ae0-4769-b4c8-17f8f230072e", "13fa7d9e-aeff-4e14-8300-58021db9ee74"));
    assertEquals(createLoadBalancerOptionsModel.azPools(), java.util.Arrays.asList(azPoolsItemModel));

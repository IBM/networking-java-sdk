...
/**
 * Unit test class for the ListPermittedNetworksOptions model.
 */
public class ListPermittedNetworksOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListPermittedNetworksOptions() throws Throwable {
  ...
  public void testListPermittedNetworksOptionsError() throws Throwable {
    new ListPermittedNetworksOptions.Builder().build();
  }

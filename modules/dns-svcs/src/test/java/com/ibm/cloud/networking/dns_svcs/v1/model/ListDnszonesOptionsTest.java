...
/**
 * Unit test class for the ListDnszonesOptions model.
 */
public class ListDnszonesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListDnszonesOptions() throws Throwable {
  ...
  public void testListDnszonesOptionsError() throws Throwable {
    new ListDnszonesOptions.Builder().build();
  }

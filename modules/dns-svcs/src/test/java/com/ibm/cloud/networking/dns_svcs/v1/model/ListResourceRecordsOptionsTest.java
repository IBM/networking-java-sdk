...
/**
 * Unit test class for the ListResourceRecordsOptions model.
 */
public class ListResourceRecordsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListResourceRecordsOptions() throws Throwable {
  ...
  public void testListResourceRecordsOptionsError() throws Throwable {
    new ListResourceRecordsOptions.Builder().build();
  }

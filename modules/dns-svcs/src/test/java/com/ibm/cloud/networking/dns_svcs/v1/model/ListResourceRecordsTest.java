...
/**
 * Unit test class for the ListResourceRecords model.
 */
public class ListResourceRecordsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListResourceRecords() throws Throwable {
    ListResourceRecords listResourceRecordsModel = new ListResourceRecords();

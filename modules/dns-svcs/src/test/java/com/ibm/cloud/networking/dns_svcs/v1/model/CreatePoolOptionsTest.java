...
public class CreatePoolOptionsTest {
  ...
  public void testCreatePoolOptions() throws Throwable {
    ...
    assertEquals(createPoolOptionsModel.origins(), java.util.Arrays.asList(originInputModel));
    ...
    assertEquals(createPoolOptionsModel.healthcheckSubnets(), java.util.Arrays.asList("crn:v1:staging:public:is:us-south-1:a/01652b251c3ae2787110a995d8db0135::subnet:0716-b49ef064-0f89-4fb1-8212-135b12568f04"));

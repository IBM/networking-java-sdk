...
/**
 * The updatePageRule options.
 */
public class UpdatePageRuleOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(UpdatePageRuleOptions updatePageRuleOptions) {
      this.ruleId = updatePageRuleOptions.ruleId;
      this.targets = updatePageRuleOptions.targets;
      this.actions = updatePageRuleOptions.actions;
      this.priority = updatePageRuleOptions.priority;
      this.status = updatePageRuleOptions.status;
    }
    ...
    /**
     * Builds a UpdatePageRuleOptions.
     *
     * @return the new UpdatePageRuleOptions instance
     */
    public UpdatePageRuleOptions build() {
      return new UpdatePageRuleOptions(this);
    }
     ...
     * @return the UpdatePageRuleOptions builder
     */
  ...
  protected UpdatePageRuleOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a UpdatePageRuleOptions builder
   */

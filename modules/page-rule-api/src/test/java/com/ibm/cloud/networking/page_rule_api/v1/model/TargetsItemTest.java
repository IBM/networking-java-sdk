...
/**
 * Unit test class for the TargetsItem model.
 */
public class TargetsItemTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testTargetsItem() throws Throwable {
    ...
    String json = TestUtilities.serialize(targetsItemModel);

    TargetsItem targetsItemModelNew = TestUtilities.deserialize(json, TargetsItem.class);
    assertTrue(targetsItemModelNew instanceof TargetsItem);
    assertEquals(targetsItemModelNew.target(), "url");
    assertEquals(targetsItemModelNew.constraint().toString(), targetsItemConstraintModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testTargetsItemError() throws Throwable {
    new TargetsItem.Builder().build();
  }

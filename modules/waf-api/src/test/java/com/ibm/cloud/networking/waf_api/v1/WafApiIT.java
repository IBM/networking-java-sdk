...
/**
 * Integration test class for the WafApi service.
 */
public class WafApiIT extends SdkIntegrationTestBase {
  public WafApi service = null;
  ...
  public void constructService() {
    ...
    try {
      service = WafApi.newInstance(crn, zoneId, serviceName);
    } catch (Exception e) {
  ...
  @Test
  public void testGetWafSettings() throws Exception {
    try {
      ...
      assertNotNull(wafResponseResult);
  ...
  @Test
  public void testUpdateWafSettings() throws Exception {
    try {

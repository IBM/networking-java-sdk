...
/**
 * Unit test class for the UpdateWafSettingsOptions model.
 */
public class UpdateWafSettingsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateWafSettingsOptions() throws Throwable {
    UpdateWafSettingsOptions updateWafSettingsOptionsModel = new UpdateWafSettingsOptions.Builder()
      .value("on")
      .build();
    assertEquals(updateWafSettingsOptionsModel.value(), "on");
  }
}
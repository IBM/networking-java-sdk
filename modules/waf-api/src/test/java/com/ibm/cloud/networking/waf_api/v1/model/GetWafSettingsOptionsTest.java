...
/**
 * Unit test class for the GetWafSettingsOptions model.
 */
public class GetWafSettingsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetWafSettingsOptions() throws Throwable {
    GetWafSettingsOptions getWafSettingsOptionsModel = new GetWafSettingsOptions();
    assertNotNull(getWafSettingsOptionsModel);
  }
}
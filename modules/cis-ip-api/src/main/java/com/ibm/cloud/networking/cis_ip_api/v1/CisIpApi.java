...
public class CisIpApi extends BaseService {
 ...
 /**
   ...
   *
   * @return an instance of the `CisIpApi` client using external configuration
   */
  ...
  public static CisIpApi newInstance(String serviceName) {
    ...
    CisIpApi service = new CisIpApi(serviceName, authenticator);
   ...
   */
  public CisIpApi(String serviceName, Authenticator authenticator) {
   ...
   * List of all IP addresses used by the CIS proxy.
   *
   * @param listIpsOptions the {@link ListIpsOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link IpResponse}
   */
  public ServiceCall<IpResponse> listIps(ListIpsOptions listIpsOptions) {
    String[] pathSegments = { "v1/ips" };
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.constructHttpUrl(getServiceUrl(), pathSegments));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("cis_ip_api", "v1", "listIps");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
    ResponseConverter<IpResponse> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<IpResponse>() { }.getType());

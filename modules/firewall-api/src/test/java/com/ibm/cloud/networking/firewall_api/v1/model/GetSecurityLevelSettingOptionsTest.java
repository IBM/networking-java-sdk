...
/**
 * Unit test class for the GetSecurityLevelSettingOptions model.
 */
public class GetSecurityLevelSettingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetSecurityLevelSettingOptions() throws Throwable {
    GetSecurityLevelSettingOptions getSecurityLevelSettingOptionsModel = new GetSecurityLevelSettingOptions();
    assertNotNull(getSecurityLevelSettingOptionsModel);
  }
}
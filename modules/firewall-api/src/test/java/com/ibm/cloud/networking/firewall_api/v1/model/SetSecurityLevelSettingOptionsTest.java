...
/**
 * Unit test class for the SetSecurityLevelSettingOptions model.
 */
public class SetSecurityLevelSettingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSetSecurityLevelSettingOptions() throws Throwable {
    SetSecurityLevelSettingOptions setSecurityLevelSettingOptionsModel = new SetSecurityLevelSettingOptions.Builder()
      .value("under_attack")
      .build();
    assertEquals(setSecurityLevelSettingOptionsModel.value(), "under_attack");
  }
}
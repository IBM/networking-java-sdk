...
/**
 * Unit test class for the CreateZoneUserAgentRuleOptions model.
 */
public class CreateZoneUserAgentRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateZoneUserAgentRuleOptions() throws Throwable {
    ...
    CreateZoneUserAgentRuleOptions createZoneUserAgentRuleOptionsModel = new CreateZoneUserAgentRuleOptions.Builder()
      ...
      .build();
    assertEquals(createZoneUserAgentRuleOptionsModel.paused(), Boolean.valueOf(true));
    assertEquals(createZoneUserAgentRuleOptionsModel.description(), "Prevent access from abusive clients identified by this UserAgent to mitigate DDoS attack");
    assertEquals(createZoneUserAgentRuleOptionsModel.mode(), "block");
    assertEquals(createZoneUserAgentRuleOptionsModel.configuration(), useragentRuleInputConfigurationModel);
  }
}
...
/**
 * Unit test class for the ListAllZoneUserAgentRulesOptions model.
 */
public class ListAllZoneUserAgentRulesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListAllZoneUserAgentRulesOptions() throws Throwable {
    ListAllZoneUserAgentRulesOptions listAllZoneUserAgentRulesOptionsModel = new ListAllZoneUserAgentRulesOptions.Builder()
      ...
      .build();
    assertEquals(listAllZoneUserAgentRulesOptionsModel.page(), Long.valueOf("26"));
    assertEquals(listAllZoneUserAgentRulesOptionsModel.perPage(), Long.valueOf("5"));
  }
}
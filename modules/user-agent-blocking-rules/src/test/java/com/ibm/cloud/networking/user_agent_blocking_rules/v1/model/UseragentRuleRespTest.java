...
/**
 * Unit test class for the UseragentRuleResp model.
 */
public class UseragentRuleRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUseragentRuleResp() throws Throwable {
    UseragentRuleResp useragentRuleRespModel = new UseragentRuleResp();
    assertNull(useragentRuleRespModel.isSuccess());
    assertNull(useragentRuleRespModel.getErrors());
    assertNull(useragentRuleRespModel.getMessages());
    assertNull(useragentRuleRespModel.getResult());
  }
}
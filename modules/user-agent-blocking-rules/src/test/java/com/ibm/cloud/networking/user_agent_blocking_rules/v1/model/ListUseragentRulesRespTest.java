...
/**
 * Unit test class for the ListUseragentRulesResp model.
 */
public class ListUseragentRulesRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListUseragentRulesResp() throws Throwable {
    ListUseragentRulesResp listUseragentRulesRespModel = new ListUseragentRulesResp();
    assertNull(listUseragentRulesRespModel.isSuccess());
    assertNull(listUseragentRulesRespModel.getErrors());
    assertNull(listUseragentRulesRespModel.getMessages());
    assertNull(listUseragentRulesRespModel.getResult());
    assertNull(listUseragentRulesRespModel.getResultInfo());
  }
}
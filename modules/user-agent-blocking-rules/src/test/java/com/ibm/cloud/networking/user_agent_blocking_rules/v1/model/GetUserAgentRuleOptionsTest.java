...
/**
 * Unit test class for the GetUserAgentRuleOptions model.
 */
public class GetUserAgentRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetUserAgentRuleOptions() throws Throwable {
    GetUserAgentRuleOptions getUserAgentRuleOptionsModel = new GetUserAgentRuleOptions.Builder()
      ...
      .build();
    assertEquals(getUserAgentRuleOptionsModel.useragentRuleIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetUserAgentRuleOptionsError() throws Throwable {
    new GetUserAgentRuleOptions.Builder().build();
  }

...
/**
 * Unit test class for the DeleteZoneUserAgentRuleOptions model.
 */
public class DeleteZoneUserAgentRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteZoneUserAgentRuleOptions() throws Throwable {
    DeleteZoneUserAgentRuleOptions deleteZoneUserAgentRuleOptionsModel = new DeleteZoneUserAgentRuleOptions.Builder()
      ...
      .build();
    assertEquals(deleteZoneUserAgentRuleOptionsModel.useragentRuleIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteZoneUserAgentRuleOptionsError() throws Throwable {
    new DeleteZoneUserAgentRuleOptions.Builder().build();
  }

...
/**
 * Unit test class for the WafRuleResponse model.
 */
public class WafRuleResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testWafRuleResponse() throws Throwable {
    WafRuleResponse wafRuleResponseModel = new WafRuleResponse();
    assertNull(wafRuleResponseModel.isSuccess());
    assertNull(wafRuleResponseModel.getErrors());
    assertNull(wafRuleResponseModel.getMessages());
    assertNull(wafRuleResponseModel.getResult());
  }
}
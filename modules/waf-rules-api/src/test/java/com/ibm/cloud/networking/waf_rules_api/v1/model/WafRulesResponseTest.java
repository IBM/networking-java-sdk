...
/**
 * Unit test class for the WafRulesResponse model.
 */
public class WafRulesResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testWafRulesResponse() throws Throwable {
    WafRulesResponse wafRulesResponseModel = new WafRulesResponse();
    assertNull(wafRulesResponseModel.isSuccess());
    assertNull(wafRulesResponseModel.getErrors());
    assertNull(wafRulesResponseModel.getMessages());
    assertNull(wafRulesResponseModel.getResult());
    assertNull(wafRulesResponseModel.getResultInfo());
  }
}
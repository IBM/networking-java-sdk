...
/**
 * Unit test class for the RangeApplicationResp model.
 */
public class RangeApplicationRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRangeApplicationResp() throws Throwable {
    RangeApplicationResp rangeApplicationRespModel = new RangeApplicationResp();
    assertNull(rangeApplicationRespModel.isSuccess());
    assertNull(rangeApplicationRespModel.getErrors());
    assertNull(rangeApplicationRespModel.getMessages());
    assertNull(rangeApplicationRespModel.getResult());
  }
}
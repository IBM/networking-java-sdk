...
/**
 * Unit test class for the GetRangeAppOptions model.
 */
public class GetRangeAppOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetRangeAppOptions() throws Throwable {
    GetRangeAppOptions getRangeAppOptionsModel = new GetRangeAppOptions.Builder()
      .appIdentifier("testString")
      .build();
    assertEquals(getRangeAppOptionsModel.appIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetRangeAppOptionsError() throws Throwable {
    new GetRangeAppOptions.Builder().build();
  }

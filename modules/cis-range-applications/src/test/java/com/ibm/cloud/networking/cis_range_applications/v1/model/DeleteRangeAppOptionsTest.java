...
/**
 * Unit test class for the DeleteRangeAppOptions model.
 */
public class DeleteRangeAppOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteRangeAppOptions() throws Throwable {
    DeleteRangeAppOptions deleteRangeAppOptionsModel = new DeleteRangeAppOptions.Builder()
      .appIdentifier("testString")
      .build();
    assertEquals(deleteRangeAppOptionsModel.appIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteRangeAppOptionsError() throws Throwable {
    new DeleteRangeAppOptions.Builder().build();
  }

...
/**
 * Unit test class for the RangeApplications model.
 */
public class RangeApplicationsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRangeApplications() throws Throwable {
    RangeApplications rangeApplicationsModel = new RangeApplications();
    assertNull(rangeApplicationsModel.isSuccess());
    assertNull(rangeApplicationsModel.getErrors());
    assertNull(rangeApplicationsModel.getMessages());
    assertNull(rangeApplicationsModel.getResult());
  }
}
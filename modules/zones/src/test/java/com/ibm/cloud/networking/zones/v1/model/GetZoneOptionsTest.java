...
/**
 * Unit test class for the GetZoneOptions model.
 */
public class GetZoneOptionsTest {
  ...
  public void testGetZoneOptions() throws Throwable {
    GetZoneOptions getZoneOptionsModel = new GetZoneOptions.Builder()
      ...
      .build();
    assertEquals(getZoneOptionsModel.zoneIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetZoneOptionsError() throws Throwable {
    new GetZoneOptions.Builder().build();
  }

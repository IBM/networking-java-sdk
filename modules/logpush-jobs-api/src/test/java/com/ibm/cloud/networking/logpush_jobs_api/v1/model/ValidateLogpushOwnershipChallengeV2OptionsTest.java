...
/**
 * Unit test class for the ValidateLogpushOwnershipChallengeV2Options model.
 */
public class ValidateLogpushOwnershipChallengeV2OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testValidateLogpushOwnershipChallengeV2Options() throws Throwable {
    ValidateLogpushOwnershipChallengeV2Options validateLogpushOwnershipChallengeV2OptionsModel = new ValidateLogpushOwnershipChallengeV2Options.Builder()
      ...
      .build();
    assertEquals(validateLogpushOwnershipChallengeV2OptionsModel.cos(), java.util.Collections.singletonMap("anyKey", "anyValue"));
    assertEquals(validateLogpushOwnershipChallengeV2OptionsModel.ownershipChallenge(), "00000000000000000000");
  }
}
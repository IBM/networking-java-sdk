...
/**
 * The deleteFirewallRule options.
 */
public class DeleteFirewallRuleOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(DeleteFirewallRuleOptions deleteFirewallRuleOptions) {
      this.xAuthUserToken = deleteFirewallRuleOptions.xAuthUserToken;
      this.crn = deleteFirewallRuleOptions.crn;
      this.zoneIdentifier = deleteFirewallRuleOptions.zoneIdentifier;
      this.firewallRuleIdentifier = deleteFirewallRuleOptions.firewallRuleIdentifier;
    }
    ...
    /**
     * Builds a DeleteFirewallRuleOptions.
     *
     * @return the new DeleteFirewallRuleOptions instance
     */
    public DeleteFirewallRuleOptions build() {
      return new DeleteFirewallRuleOptions(this);
    }
     ...
     *
     * @param xAuthUserToken the xAuthUserToken
     * @return the DeleteFirewallRuleOptions builder
     */
  ...
  protected DeleteFirewallRuleOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a DeleteFirewallRuleOptions builder
   */

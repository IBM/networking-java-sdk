...
/**
 * Unit test class for the CreateAccessOrganizationOptions model.
 */
public class CreateAccessOrganizationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateAccessOrganizationOptions() throws Throwable {
    CreateAccessOrganizationOptions createAccessOrganizationOptionsModel = new CreateAccessOrganizationOptions.Builder()
      ...
      .build();
    assertEquals(createAccessOrganizationOptionsModel.name(), "MTLS enabled");
    assertEquals(createAccessOrganizationOptionsModel.authDomain(), "01652b251c3ae2787110a995d8db0135.cloudflareaccess.com");
  }
}
...
/**
 * Unit test class for the PolicyRule model.
 */
public class PolicyRuleTest {
  ...
  @Test
  public void testPolicyRule() throws Throwable {
    PolicyRule policyRuleModel = new PolicyRule();
    assertNotNull(policyRuleModel);
  }
}
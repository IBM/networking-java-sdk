...
/**
 * Unit test class for the AccessAppResp model.
 */
public class AccessAppRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAccessAppResp() throws Throwable {
    AccessAppResp accessAppRespModel = new AccessAppResp();
    assertNull(accessAppRespModel.isSuccess());
    assertNull(accessAppRespModel.getErrors());
    assertNull(accessAppRespModel.getMessages());
    assertNull(accessAppRespModel.getResult());
  }
}
 ...
 */
public class CreateAccessAppResp extends GenericModel {

  protected Boolean success;
  protected List<List<String>> errors;
  protected List<List<String>> messages;
  protected CreateAccessAppRespResult result;

  protected CreateAccessAppResp() { }
   ...
   * @return the result
   */
  public CreateAccessAppRespResult getResult() {
    return result;
  }
}

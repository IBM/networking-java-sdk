...
/**
 * Unit test class for the UpdateInstanceRulesetRuleOptions model.
 */
public class UpdateInstanceRulesetRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateInstanceRulesetRuleOptions() throws Throwable {
    ...
    UpdateInstanceRulesetRuleOptions updateInstanceRulesetRuleOptionsModel = new UpdateInstanceRulesetRuleOptions.Builder()
      ...
      .build();
    assertEquals(updateInstanceRulesetRuleOptionsModel.rulesetId(), "testString");
    assertEquals(updateInstanceRulesetRuleOptionsModel.ruleId(), "testString");
    assertEquals(updateInstanceRulesetRuleOptionsModel.action(), "testString");
    assertEquals(updateInstanceRulesetRuleOptionsModel.actionParameters(), actionParametersModel);
    assertEquals(updateInstanceRulesetRuleOptionsModel.ratelimit(), ratelimitModel);
    assertEquals(updateInstanceRulesetRuleOptionsModel.description(), "testString");
    assertEquals(updateInstanceRulesetRuleOptionsModel.enabled(), Boolean.valueOf(true));
    assertEquals(updateInstanceRulesetRuleOptionsModel.expression(), "ip.src ne 1.1.1.1");
    assertEquals(updateInstanceRulesetRuleOptionsModel.id(), "testString");
    assertEquals(updateInstanceRulesetRuleOptionsModel.logging(), loggingModel);
    assertEquals(updateInstanceRulesetRuleOptionsModel.ref(), "my_ref");
    assertEquals(updateInstanceRulesetRuleOptionsModel.position(), positionModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateInstanceRulesetRuleOptionsError() throws Throwable {
    new UpdateInstanceRulesetRuleOptions.Builder().build();
  }

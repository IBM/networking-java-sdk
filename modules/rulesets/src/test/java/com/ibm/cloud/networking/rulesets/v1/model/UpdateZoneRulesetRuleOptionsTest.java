...
/**
 * Unit test class for the UpdateZoneRulesetRuleOptions model.
 */
public class UpdateZoneRulesetRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateZoneRulesetRuleOptions() throws Throwable {
    ...
    UpdateZoneRulesetRuleOptions updateZoneRulesetRuleOptionsModel = new UpdateZoneRulesetRuleOptions.Builder()
      ...
      .build();
    assertEquals(updateZoneRulesetRuleOptionsModel.rulesetId(), "testString");
    assertEquals(updateZoneRulesetRuleOptionsModel.ruleId(), "testString");
    assertEquals(updateZoneRulesetRuleOptionsModel.action(), "testString");
    assertEquals(updateZoneRulesetRuleOptionsModel.actionParameters(), actionParametersModel);
    assertEquals(updateZoneRulesetRuleOptionsModel.ratelimit(), ratelimitModel);
    assertEquals(updateZoneRulesetRuleOptionsModel.description(), "testString");
    assertEquals(updateZoneRulesetRuleOptionsModel.enabled(), Boolean.valueOf(true));
    assertEquals(updateZoneRulesetRuleOptionsModel.expression(), "ip.src ne 1.1.1.1");
    assertEquals(updateZoneRulesetRuleOptionsModel.id(), "testString");
    assertEquals(updateZoneRulesetRuleOptionsModel.logging(), loggingModel);
    assertEquals(updateZoneRulesetRuleOptionsModel.ref(), "my_ref");
    assertEquals(updateZoneRulesetRuleOptionsModel.position(), positionModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateZoneRulesetRuleOptionsError() throws Throwable {
    new UpdateZoneRulesetRuleOptions.Builder().build();
  }

...
/**
 * Unit test class for the UpdateInstanceEntrypointRulesetOptions model.
 */
public class UpdateInstanceEntrypointRulesetOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateInstanceEntrypointRulesetOptions() throws Throwable {
    ...
    UpdateInstanceEntrypointRulesetOptions updateInstanceEntrypointRulesetOptionsModel = new UpdateInstanceEntrypointRulesetOptions.Builder()
      ...
      .build();
    assertEquals(updateInstanceEntrypointRulesetOptionsModel.rulesetPhase(), "ddos_l4");
    assertEquals(updateInstanceEntrypointRulesetOptionsModel.description(), "Custom instance ruleset");
    assertEquals(updateInstanceEntrypointRulesetOptionsModel.kind(), "managed");
    assertEquals(updateInstanceEntrypointRulesetOptionsModel.name(), "testString");
    assertEquals(updateInstanceEntrypointRulesetOptionsModel.phase(), "ddos_l4");
    assertEquals(updateInstanceEntrypointRulesetOptionsModel.rules(), java.util.Arrays.asList(ruleCreateModel));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateInstanceEntrypointRulesetOptionsError() throws Throwable {
    new UpdateInstanceEntrypointRulesetOptions.Builder().build();
  }

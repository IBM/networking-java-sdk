...
/**
 * Unit test class for the GetZoneRulesetsOptions model.
 */
public class GetZoneRulesetsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetZoneRulesetsOptions() throws Throwable {
    GetZoneRulesetsOptions getZoneRulesetsOptionsModel = new GetZoneRulesetsOptions();
    assertNotNull(getZoneRulesetsOptionsModel);
  }
}
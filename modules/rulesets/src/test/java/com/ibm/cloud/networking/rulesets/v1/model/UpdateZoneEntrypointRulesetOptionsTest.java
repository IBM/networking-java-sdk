...
/**
 * Unit test class for the UpdateZoneEntrypointRulesetOptions model.
 */
public class UpdateZoneEntrypointRulesetOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateZoneEntrypointRulesetOptions() throws Throwable {
    ...
    UpdateZoneEntrypointRulesetOptions updateZoneEntrypointRulesetOptionsModel = new UpdateZoneEntrypointRulesetOptions.Builder()
      ...
      .build();
    assertEquals(updateZoneEntrypointRulesetOptionsModel.rulesetPhase(), "ddos_l4");
    assertEquals(updateZoneEntrypointRulesetOptionsModel.description(), "Custom instance ruleset");
    assertEquals(updateZoneEntrypointRulesetOptionsModel.kind(), "managed");
    assertEquals(updateZoneEntrypointRulesetOptionsModel.name(), "testString");
    assertEquals(updateZoneEntrypointRulesetOptionsModel.phase(), "ddos_l4");
    assertEquals(updateZoneEntrypointRulesetOptionsModel.rules(), java.util.Arrays.asList(ruleCreateModel));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateZoneEntrypointRulesetOptionsError() throws Throwable {
    new UpdateZoneEntrypointRulesetOptions.Builder().build();
  }

...
/**
 * Unit test class for the CreateZoneRulesetRuleOptions model.
 */
public class CreateZoneRulesetRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateZoneRulesetRuleOptions() throws Throwable {
    ...
    CreateZoneRulesetRuleOptions createZoneRulesetRuleOptionsModel = new CreateZoneRulesetRuleOptions.Builder()
      ...
      .build();
    assertEquals(createZoneRulesetRuleOptionsModel.rulesetId(), "testString");
    assertEquals(createZoneRulesetRuleOptionsModel.action(), "testString");
    assertEquals(createZoneRulesetRuleOptionsModel.actionParameters(), actionParametersModel);
    assertEquals(createZoneRulesetRuleOptionsModel.ratelimit(), ratelimitModel);
    assertEquals(createZoneRulesetRuleOptionsModel.description(), "testString");
    assertEquals(createZoneRulesetRuleOptionsModel.enabled(), Boolean.valueOf(true));
    assertEquals(createZoneRulesetRuleOptionsModel.expression(), "ip.src ne 1.1.1.1");
    assertEquals(createZoneRulesetRuleOptionsModel.id(), "testString");
    assertEquals(createZoneRulesetRuleOptionsModel.logging(), loggingModel);
    assertEquals(createZoneRulesetRuleOptionsModel.ref(), "my_ref");
    assertEquals(createZoneRulesetRuleOptionsModel.position(), positionModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateZoneRulesetRuleOptionsError() throws Throwable {
    new CreateZoneRulesetRuleOptions.Builder().build();
  }

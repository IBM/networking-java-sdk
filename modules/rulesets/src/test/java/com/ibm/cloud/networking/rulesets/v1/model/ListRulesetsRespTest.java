...
/**
 * Unit test class for the ListRulesetsResp model.
 */
public class ListRulesetsRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListRulesetsResp() throws Throwable {
    ListRulesetsResp listRulesetsRespModel = new ListRulesetsResp();
    assertNull(listRulesetsRespModel.isSuccess());
    assertNull(listRulesetsRespModel.getErrors());
    assertNull(listRulesetsRespModel.getMessages());
    assertNull(listRulesetsRespModel.getResult());
  }
}
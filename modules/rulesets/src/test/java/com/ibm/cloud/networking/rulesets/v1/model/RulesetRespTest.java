...
/**
 * Unit test class for the RulesetResp model.
 */
public class RulesetRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRulesetResp() throws Throwable {
    RulesetResp rulesetRespModel = new RulesetResp();
    assertNull(rulesetRespModel.isSuccess());
    assertNull(rulesetRespModel.getErrors());
    assertNull(rulesetRespModel.getMessages());
    assertNull(rulesetRespModel.getResult());
  }
}
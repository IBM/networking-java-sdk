...
/**
 * Unit test class for the UpdateInstanceRulesetOptions model.
 */
public class UpdateInstanceRulesetOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateInstanceRulesetOptions() throws Throwable {
    ...
    UpdateInstanceRulesetOptions updateInstanceRulesetOptionsModel = new UpdateInstanceRulesetOptions.Builder()
      ...
      .build();
    assertEquals(updateInstanceRulesetOptionsModel.rulesetId(), "testString");
    assertEquals(updateInstanceRulesetOptionsModel.description(), "Custom instance ruleset");
    assertEquals(updateInstanceRulesetOptionsModel.kind(), "managed");
    assertEquals(updateInstanceRulesetOptionsModel.name(), "testString");
    assertEquals(updateInstanceRulesetOptionsModel.phase(), "ddos_l4");
    assertEquals(updateInstanceRulesetOptionsModel.rules(), java.util.Arrays.asList(ruleCreateModel));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateInstanceRulesetOptionsError() throws Throwable {
    new UpdateInstanceRulesetOptions.Builder().build();
  }

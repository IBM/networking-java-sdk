...
/**
 * Unit test class for the RuleDetails model.
 */
public class RuleDetailsTest {
  ...
  @Test
  public void testRuleDetails() throws Throwable {
    RuleDetails ruleDetailsModel = new RuleDetails();
    assertNull(ruleDetailsModel.getId());
    assertNull(ruleDetailsModel.getVersion());
    assertNull(ruleDetailsModel.getAction());
    assertNull(ruleDetailsModel.getActionParameters());
    assertNull(ruleDetailsModel.getCategories());
    assertNull(ruleDetailsModel.isEnabled());
    assertNull(ruleDetailsModel.getDescription());
    assertNull(ruleDetailsModel.getExpression());
    assertNull(ruleDetailsModel.getRef());
    assertNull(ruleDetailsModel.getLogging());
    assertNull(ruleDetailsModel.getLastUpdated());
  }
}
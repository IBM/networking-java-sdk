...
/**
 * Unit test class for the UpdateZoneRulesetOptions model.
 */
public class UpdateZoneRulesetOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateZoneRulesetOptions() throws Throwable {
    ...
    UpdateZoneRulesetOptions updateZoneRulesetOptionsModel = new UpdateZoneRulesetOptions.Builder()
      ...
      .build();
    assertEquals(updateZoneRulesetOptionsModel.rulesetId(), "testString");
    assertEquals(updateZoneRulesetOptionsModel.description(), "Custom instance ruleset");
    assertEquals(updateZoneRulesetOptionsModel.kind(), "managed");
    assertEquals(updateZoneRulesetOptionsModel.name(), "testString");
    assertEquals(updateZoneRulesetOptionsModel.phase(), "ddos_l4");
    assertEquals(updateZoneRulesetOptionsModel.rules(), java.util.Arrays.asList(ruleCreateModel));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateZoneRulesetOptionsError() throws Throwable {
    new UpdateZoneRulesetOptions.Builder().build();
  }

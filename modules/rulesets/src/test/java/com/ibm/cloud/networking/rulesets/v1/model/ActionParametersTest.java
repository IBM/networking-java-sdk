...
/**
 * Unit test class for the ActionParameters model.
 */
public class ActionParametersTest {
  ...
  @Test
  public void testActionParameters() throws Throwable {
    ...
    String json = TestUtilities.serialize(actionParametersModel);

    ActionParameters actionParametersModelNew = TestUtilities.deserialize(json, ActionParameters.class);
    assertTrue(actionParametersModelNew instanceof ActionParameters);
    assertEquals(actionParametersModelNew.id(), "testString");
    assertEquals(actionParametersModelNew.overrides().toString(), overridesModel.toString());
    assertEquals(actionParametersModelNew.version(), "testString");
    assertEquals(actionParametersModelNew.ruleset(), "testString");
    assertEquals(actionParametersModelNew.response().toString(), actionParametersResponseModel.toString());
  }
}
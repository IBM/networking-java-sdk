...
/**
 * Unit test class for the GetInstanceRulesetsOptions model.
 */
public class GetInstanceRulesetsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetInstanceRulesetsOptions() throws Throwable {
    GetInstanceRulesetsOptions getInstanceRulesetsOptionsModel = new GetInstanceRulesetsOptions();
    assertNotNull(getInstanceRulesetsOptionsModel);
  }
}
...
/**
 * Unit test class for the RuleResp model.
 */
public class RuleRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRuleResp() throws Throwable {
    RuleResp ruleRespModel = new RuleResp();
    assertNull(ruleRespModel.isSuccess());
    assertNull(ruleRespModel.getErrors());
    assertNull(ruleRespModel.getMessages());
    assertNull(ruleRespModel.getResult());
  }
}
...
/**
 * The updateZoneRuleset options.
 */
public class UpdateZoneRulesetOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateZoneRulesetOptions instance.
     *
     * @param updateZoneRulesetOptions the instance to initialize the Builder with
     */
    private Builder(UpdateZoneRulesetOptions updateZoneRulesetOptions) {
      this.rulesetId = updateZoneRulesetOptions.rulesetId;
      this.description = updateZoneRulesetOptions.description;
      this.kind = updateZoneRulesetOptions.kind;
      this.name = updateZoneRulesetOptions.name;
      this.phase = updateZoneRulesetOptions.phase;
      this.rules = updateZoneRulesetOptions.rules;
    }
    ...
    /**
     * Builds a UpdateZoneRulesetOptions.
     *
     * @return the new UpdateZoneRulesetOptions instance
     */
    public UpdateZoneRulesetOptions build() {
      return new UpdateZoneRulesetOptions(this);
    }
     ...
     * @return the UpdateZoneRulesetOptions builder
     */
  ...
  protected UpdateZoneRulesetOptions() { }

  protected UpdateZoneRulesetOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a UpdateZoneRulesetOptions builder
   */

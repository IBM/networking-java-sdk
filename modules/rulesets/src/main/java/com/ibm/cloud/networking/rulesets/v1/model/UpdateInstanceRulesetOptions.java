...
public class UpdateInstanceRulesetOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateInstanceRulesetOptions instance.
     *
     * @param updateInstanceRulesetOptions the instance to initialize the Builder with
     */
    private Builder(UpdateInstanceRulesetOptions updateInstanceRulesetOptions) {
      this.rulesetId = updateInstanceRulesetOptions.rulesetId;
      this.description = updateInstanceRulesetOptions.description;
      this.kind = updateInstanceRulesetOptions.kind;
      this.name = updateInstanceRulesetOptions.name;
      this.phase = updateInstanceRulesetOptions.phase;
      this.rules = updateInstanceRulesetOptions.rules;
    }
    ...
    /**
     * Builds a UpdateInstanceRulesetOptions.
     *
     * @return the new UpdateInstanceRulesetOptions instance
     */
    public UpdateInstanceRulesetOptions build() {
      return new UpdateInstanceRulesetOptions(this);
    }
     ...
     * @return the UpdateInstanceRulesetOptions builder
     */
  ...
  protected UpdateInstanceRulesetOptions() { }

  protected UpdateInstanceRulesetOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a UpdateInstanceRulesetOptions builder
   */

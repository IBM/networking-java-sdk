...
/**
 * Unit test class for the ListAllLoadBalancersOptions model.
 */
public class ListAllLoadBalancersOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListAllLoadBalancersOptions() throws Throwable {
    ListAllLoadBalancersOptions listAllLoadBalancersOptionsModel = new ListAllLoadBalancersOptions();
    assertNotNull(listAllLoadBalancersOptionsModel);
  }
}
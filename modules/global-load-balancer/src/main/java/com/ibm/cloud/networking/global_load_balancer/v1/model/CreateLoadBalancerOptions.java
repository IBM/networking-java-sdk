...
public class CreateLoadBalancerOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(CreateLoadBalancerOptions createLoadBalancerOptions) {
      ...
      this.fallbackPool = createLoadBalancerOptions.fallbackPool;
      this.defaultPools = createLoadBalancerOptions.defaultPools;
      this.description = createLoadBalancerOptions.description;
      this.ttl = createLoadBalancerOptions.ttl;
      this.regionPools = createLoadBalancerOptions.regionPools;
      this.popPools = createLoadBalancerOptions.popPools;
      this.proxied = createLoadBalancerOptions.proxied;
      this.enabled = createLoadBalancerOptions.enabled;
      this.sessionAffinity = createLoadBalancerOptions.sessionAffinity;
      this.steeringPolicy = createLoadBalancerOptions.steeringPolicy;
    }

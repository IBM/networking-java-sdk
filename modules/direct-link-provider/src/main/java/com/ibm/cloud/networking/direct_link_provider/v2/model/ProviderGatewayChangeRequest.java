 ...
 */
public class ProviderGatewayChangeRequest extends GenericModel {
  ...
  protected List<ProviderGatewayUpdateAttributesUpdatesItem> updates;

  protected ProviderGatewayChangeRequest() {
  }
   ...
   * @return the updates
   */
  public List<ProviderGatewayUpdateAttributesUpdatesItem> getUpdates() {
    return updates;
  }
}

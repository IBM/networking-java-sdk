...
/**
 * Unit test class for the GetProviderGatewayOptions model.
 */
public class GetProviderGatewayOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetProviderGatewayOptions() throws Throwable {
    GetProviderGatewayOptions getProviderGatewayOptionsModel = new GetProviderGatewayOptions.Builder()
      .id("testString")
      .build();
    assertEquals(getProviderGatewayOptionsModel.id(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetProviderGatewayOptionsError() throws Throwable {
    new GetProviderGatewayOptions.Builder().build();
  }

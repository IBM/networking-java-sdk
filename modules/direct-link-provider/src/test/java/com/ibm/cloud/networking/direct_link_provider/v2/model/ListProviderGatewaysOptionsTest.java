...
/**
 * Unit test class for the ListProviderGatewaysOptions model.
 */
public class ListProviderGatewaysOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListProviderGatewaysOptions() throws Throwable {
    ListProviderGatewaysOptions listProviderGatewaysOptionsModel = new ListProviderGatewaysOptions.Builder()
      .start("testString")
      .limit(Long.valueOf("50"))
      .build();
    assertEquals(listProviderGatewaysOptionsModel.start(), "testString");
    assertEquals(listProviderGatewaysOptionsModel.limit(), Long.valueOf("50"));
  }
}
...
/**
 * Unit test class for the GetProviderPortOptions model.
 */
public class GetProviderPortOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetProviderPortOptions() throws Throwable {
    GetProviderPortOptions getProviderPortOptionsModel = new GetProviderPortOptions.Builder()
      .id("testString")
      .build();
    assertEquals(getProviderPortOptionsModel.id(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetProviderPortOptionsError() throws Throwable {
    new GetProviderPortOptions.Builder().build();
  }

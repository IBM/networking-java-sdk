...
/**
 * Unit test class for the ProviderPortCollection model.
 */
public class ProviderPortCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testProviderPortCollection() throws Throwable {
    ProviderPortCollection providerPortCollectionModel = new ProviderPortCollection();
    assertNull(providerPortCollectionModel.getFirst());
    assertNull(providerPortCollectionModel.getLimit());
    assertNull(providerPortCollectionModel.getNext());
    assertNull(providerPortCollectionModel.getTotalCount());
    assertNull(providerPortCollectionModel.getPorts());
  }
}
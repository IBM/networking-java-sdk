...
/**
 * Integration test class for the DirectLinkApis service.
 * 
 * How to run the tests:
 *    mvn -Dtest=DirectLinkApisIT -DfailIfNoTests=false test
 */

public class DirectLinkApisIT extends SdkIntegrationTestBase {
	// Directlink service v1 integration
	public DirectLinkApis testService = null;

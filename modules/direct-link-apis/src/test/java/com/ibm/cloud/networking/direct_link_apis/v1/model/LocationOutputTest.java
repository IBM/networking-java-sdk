...
/**
 * Unit test class for the LocationOutput model.
 */
public class LocationOutputTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testLocationOutput() throws Throwable {
    LocationOutput locationOutputModel = new LocationOutput();
    assertNull(locationOutputModel.getBillingLocation());
    ...
    assertNull(locationOutputModel.getName());
    assertNull(locationOutputModel.getOfferingType());
    assertNull(locationOutputModel.isProvisionEnabled());
    assertNull(locationOutputModel.getVpcRegion());
  }
}
...
/**
 * Unit test class for the GatewayChangeRequest model.
 */
public class GatewayChangeRequestTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testGatewayChangeRequest() throws Throwable {
    GatewayChangeRequest gatewayChangeRequestModel = new GatewayChangeRequest();
    assertNotNull(gatewayChangeRequestModel);
  }
}
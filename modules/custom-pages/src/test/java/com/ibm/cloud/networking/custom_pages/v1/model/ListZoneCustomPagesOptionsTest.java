...
/**
 * Unit test class for the ListZoneCustomPagesOptions model.
 */
public class ListZoneCustomPagesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListZoneCustomPagesOptions() throws Throwable {
    ListZoneCustomPagesOptions listZoneCustomPagesOptionsModel = new ListZoneCustomPagesOptions();
    assertNotNull(listZoneCustomPagesOptionsModel);
  }
}
...
/**
 * Unit test class for the ListInstanceCustomPagesOptions model.
 */
public class ListInstanceCustomPagesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListInstanceCustomPagesOptions() throws Throwable {
    ListInstanceCustomPagesOptions listInstanceCustomPagesOptionsModel = new ListInstanceCustomPagesOptions();
    assertNotNull(listInstanceCustomPagesOptionsModel);
  }
}
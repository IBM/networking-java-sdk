 ...
 */
public class UpdateInstanceCustomPageOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(UpdateInstanceCustomPageOptions updateInstanceCustomPageOptions) {
      this.pageIdentifier = updateInstanceCustomPageOptions.pageIdentifier;
      this.url = updateInstanceCustomPageOptions.url;
      this.state = updateInstanceCustomPageOptions.state;
    }
    ...
    /**
     * Builds a UpdateInstanceCustomPageOptions.
     *
     * @return the new UpdateInstanceCustomPageOptions instance
     */
    public UpdateInstanceCustomPageOptions build() {
      return new UpdateInstanceCustomPageOptions(this);
    }
     ...
     *
     * @param pageIdentifier the pageIdentifier
     * @return the UpdateInstanceCustomPageOptions builder
     */
  ...
  protected UpdateInstanceCustomPageOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a UpdateInstanceCustomPageOptions builder
   */

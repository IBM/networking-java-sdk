 ...
 */
public class GetInstanceCustomPageOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetInstanceCustomPageOptions getInstanceCustomPageOptions) {
      this.pageIdentifier = getInstanceCustomPageOptions.pageIdentifier;
    }
    ...
    /**
     * Builds a GetInstanceCustomPageOptions.
     *
     * @return the new GetInstanceCustomPageOptions instance
     */
    public GetInstanceCustomPageOptions build() {
      return new GetInstanceCustomPageOptions(this);
    }
     ...
     *
     * @param pageIdentifier the pageIdentifier
     * @return the GetInstanceCustomPageOptions builder
     */
  ...
  protected GetInstanceCustomPageOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetInstanceCustomPageOptions builder
   */

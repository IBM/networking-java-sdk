...
/**
 * Unit test class for the DeleteLoadBalancerMonitorOptions model.
 */
public class DeleteLoadBalancerMonitorOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteLoadBalancerMonitorOptions() throws Throwable {
    DeleteLoadBalancerMonitorOptions deleteLoadBalancerMonitorOptionsModel = new DeleteLoadBalancerMonitorOptions.Builder()
      ...
      .build();
    assertEquals(deleteLoadBalancerMonitorOptionsModel.monitorIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteLoadBalancerMonitorOptionsError() throws Throwable {
    new DeleteLoadBalancerMonitorOptions.Builder().build();
  }

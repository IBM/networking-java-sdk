...
/**
 * Unit test class for the ListAllLoadBalancerMonitorsOptions model.
 */
public class ListAllLoadBalancerMonitorsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListAllLoadBalancerMonitorsOptions() throws Throwable {
    ListAllLoadBalancerMonitorsOptions listAllLoadBalancerMonitorsOptionsModel = new ListAllLoadBalancerMonitorsOptions();
    assertNotNull(listAllLoadBalancerMonitorsOptionsModel);
  }
}
...
/**
 * Unit test class for the ListMonitorResp model.
 */
public class ListMonitorRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListMonitorResp() throws Throwable {
    ListMonitorResp listMonitorRespModel = new ListMonitorResp();
    assertNull(listMonitorRespModel.isSuccess());
    assertNull(listMonitorRespModel.getErrors());
    assertNull(listMonitorRespModel.getMessages());
    assertNull(listMonitorRespModel.getResult());
    assertNull(listMonitorRespModel.getResultInfo());
  }
}
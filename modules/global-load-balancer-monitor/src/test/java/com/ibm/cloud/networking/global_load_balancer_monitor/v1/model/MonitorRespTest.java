...
/**
 * Unit test class for the MonitorResp model.
 */
public class MonitorRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testMonitorResp() throws Throwable {
    MonitorResp monitorRespModel = new MonitorResp();
    assertNull(monitorRespModel.isSuccess());
    assertNull(monitorRespModel.getErrors());
    assertNull(monitorRespModel.getMessages());
    assertNull(monitorRespModel.getResult());
  }
}
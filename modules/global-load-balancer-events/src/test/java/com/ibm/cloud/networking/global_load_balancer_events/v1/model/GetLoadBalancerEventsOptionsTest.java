...
/**
 * Unit test class for the GetLoadBalancerEventsOptions model.
 */
public class GetLoadBalancerEventsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetLoadBalancerEventsOptions() throws Throwable {
    GetLoadBalancerEventsOptions getLoadBalancerEventsOptionsModel = new GetLoadBalancerEventsOptions();
    assertNotNull(getLoadBalancerEventsOptionsModel);
  }
}
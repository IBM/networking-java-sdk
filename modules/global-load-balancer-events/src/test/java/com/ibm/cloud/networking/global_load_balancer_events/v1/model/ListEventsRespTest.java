...
/**
 * Unit test class for the ListEventsResp model.
 */
public class ListEventsRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListEventsResp() throws Throwable {
    ListEventsResp listEventsRespModel = new ListEventsResp();
    assertNull(listEventsRespModel.isSuccess());
    assertNull(listEventsRespModel.getResult());
    assertNull(listEventsRespModel.getResultInfo());
    assertNull(listEventsRespModel.getErrors());
    assertNull(listEventsRespModel.getMessages());
  }
}
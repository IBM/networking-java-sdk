...
/**
 * Unit test class for the ListEventsRespResultItem model.
 */
public class ListEventsRespResultItemTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListEventsRespResultItem() throws Throwable {
    ListEventsRespResultItem listEventsRespResultItemModel = new ListEventsRespResultItem();
    assertNull(listEventsRespResultItemModel.getId());
    assertNull(listEventsRespResultItemModel.getTimestamp());
    assertNull(listEventsRespResultItemModel.getPool());
    assertNull(listEventsRespResultItemModel.getOrigins());
  }
}
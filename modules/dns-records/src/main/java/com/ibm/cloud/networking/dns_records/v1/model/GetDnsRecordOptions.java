...
public class GetDnsRecordOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing GetDnsRecordOptions instance.
     *
     * @param getDnsRecordOptions the instance to initialize the Builder with
     */

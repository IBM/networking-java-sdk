...
/**
 * Unit test class for the GetDnsRecordsBulkOptions model.
 */
public class GetDnsRecordsBulkOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetDnsRecordsBulkOptions() throws Throwable {
    GetDnsRecordsBulkOptions getDnsRecordsBulkOptionsModel = new GetDnsRecordsBulkOptions();
    assertNotNull(getDnsRecordsBulkOptionsModel);
  }
}
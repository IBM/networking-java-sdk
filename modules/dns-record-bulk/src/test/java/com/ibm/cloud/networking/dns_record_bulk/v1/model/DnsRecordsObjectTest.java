...
/**
 * Unit test class for the DnsRecordsObject model.
 */
public class DnsRecordsObjectTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDnsRecordsObject() throws Throwable {
    DnsRecordsObject dnsRecordsObjectModel = new DnsRecordsObject();
    assertNull(dnsRecordsObjectModel.isSuccess());
    assertNull(dnsRecordsObjectModel.getErrors());
    assertNull(dnsRecordsObjectModel.getMessages());
    assertNull(dnsRecordsObjectModel.getResult());
    assertNull(dnsRecordsObjectModel.getTiming());
  }
}
 ...
 */
public class DeleteAccountAccessRuleResp extends GenericModel {

  protected Boolean success;
  protected List<List<String>> errors;
  protected List<List<String>> messages;
  protected DeleteAccountAccessRuleRespResult result;
   ...
   * @return the result
   */
  public DeleteAccountAccessRuleRespResult getResult() {
    return result;
  }
}

...
/**
 * The deleteAccountAccessRule options.
 */
public class DeleteAccountAccessRuleOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Builds a DeleteAccountAccessRuleOptions.
     *
     * @return the new DeleteAccountAccessRuleOptions instance
     */
     ...
     *
     * @param accessruleIdentifier the accessruleIdentifier
     * @return the DeleteAccountAccessRuleOptions builder
     */
   ...
   * New builder.
   *
   * @return a DeleteAccountAccessRuleOptions builder
   */

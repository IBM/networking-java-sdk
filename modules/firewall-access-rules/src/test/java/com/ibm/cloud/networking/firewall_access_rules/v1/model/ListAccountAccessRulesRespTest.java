...
/**
 * Unit test class for the ListAccountAccessRulesResp model.
 */
public class ListAccountAccessRulesRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListAccountAccessRulesResp() throws Throwable {
    ListAccountAccessRulesResp listAccountAccessRulesRespModel = new ListAccountAccessRulesResp();
    assertNull(listAccountAccessRulesRespModel.isSuccess());
    assertNull(listAccountAccessRulesRespModel.getErrors());
    assertNull(listAccountAccessRulesRespModel.getMessages());
    assertNull(listAccountAccessRulesRespModel.getResult());
    assertNull(listAccountAccessRulesRespModel.getResultInfo());
  }
}
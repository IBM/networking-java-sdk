...
/**
 * Unit test class for the DeleteAccountAccessRuleOptions model.
 */
public class DeleteAccountAccessRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteAccountAccessRuleOptions() throws Throwable {
    DeleteAccountAccessRuleOptions deleteAccountAccessRuleOptionsModel = new DeleteAccountAccessRuleOptions.Builder()
      ...
      .build();
    assertEquals(deleteAccountAccessRuleOptionsModel.accessruleIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteAccountAccessRuleOptionsError() throws Throwable {
    new DeleteAccountAccessRuleOptions.Builder().build();
  }

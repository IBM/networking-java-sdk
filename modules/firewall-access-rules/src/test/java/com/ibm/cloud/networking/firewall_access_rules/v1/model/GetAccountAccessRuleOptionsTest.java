...
/**
 * Unit test class for the GetAccountAccessRuleOptions model.
 */
public class GetAccountAccessRuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAccountAccessRuleOptions() throws Throwable {
    GetAccountAccessRuleOptions getAccountAccessRuleOptionsModel = new GetAccountAccessRuleOptions.Builder()
      ...
      .build();
    assertEquals(getAccountAccessRuleOptionsModel.accessruleIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetAccountAccessRuleOptionsError() throws Throwable {
    new GetAccountAccessRuleOptions.Builder().build();
  }

...
/**
 * Unit test class for the AccountAccessRuleResp model.
 */
public class AccountAccessRuleRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAccountAccessRuleResp() throws Throwable {
    AccountAccessRuleResp accountAccessRuleRespModel = new AccountAccessRuleResp();
    assertNull(accountAccessRuleRespModel.isSuccess());
    assertNull(accountAccessRuleRespModel.getErrors());
    assertNull(accountAccessRuleRespModel.getMessages());
    assertNull(accountAccessRuleRespModel.getResult());
  }
}
...
/**
 * Unit test class for the GetApiGatewaySchemasOptions model.
 */
public class GetApiGatewaySchemasOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetApiGatewaySchemasOptions() throws Throwable {
    GetApiGatewaySchemasOptions getApiGatewaySchemasOptionsModel = new GetApiGatewaySchemasOptions();
    assertNotNull(getApiGatewaySchemasOptionsModel);
  }
}
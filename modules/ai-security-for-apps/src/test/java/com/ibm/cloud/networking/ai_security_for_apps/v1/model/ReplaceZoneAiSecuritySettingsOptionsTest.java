...
/**
 * Unit test class for the ReplaceZoneAiSecuritySettingsOptions model.
 */
public class ReplaceZoneAiSecuritySettingsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceZoneAiSecuritySettingsOptions() throws Throwable {
    ReplaceZoneAiSecuritySettingsOptions replaceZoneAiSecuritySettingsOptionsModel = new ReplaceZoneAiSecuritySettingsOptions.Builder()
      .enabled(true)
      .build();
    assertEquals(replaceZoneAiSecuritySettingsOptionsModel.enabled(), Boolean.valueOf(true));
  }
}
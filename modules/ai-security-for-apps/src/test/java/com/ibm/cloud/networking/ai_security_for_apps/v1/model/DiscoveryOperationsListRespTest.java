...
/**
 * Unit test class for the DiscoveryOperationsListResp model.
 */
public class DiscoveryOperationsListRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDiscoveryOperationsListResp() throws Throwable {
    DiscoveryOperationsListResp discoveryOperationsListRespModel = new DiscoveryOperationsListResp();
    assertNull(discoveryOperationsListRespModel.isSuccess());
    assertNull(discoveryOperationsListRespModel.getErrors());
    assertNull(discoveryOperationsListRespModel.getMessages());
    assertNull(discoveryOperationsListRespModel.getResult());
    assertNull(discoveryOperationsListRespModel.getResultInfo());
  }
}
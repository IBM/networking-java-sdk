...
/**
 * Unit test class for the DiscoveryOperationsPatchResp model.
 */
public class DiscoveryOperationsPatchRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDiscoveryOperationsPatchResp() throws Throwable {
    DiscoveryOperationsPatchResp discoveryOperationsPatchRespModel = new DiscoveryOperationsPatchResp();
    assertNull(discoveryOperationsPatchRespModel.isSuccess());
    assertNull(discoveryOperationsPatchRespModel.getErrors());
    assertNull(discoveryOperationsPatchRespModel.getMessages());
    assertNull(discoveryOperationsPatchRespModel.getResult());
  }
}
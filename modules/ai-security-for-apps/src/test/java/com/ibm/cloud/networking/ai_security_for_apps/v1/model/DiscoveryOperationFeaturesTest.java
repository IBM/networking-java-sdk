...
/**
 * Unit test class for the DiscoveryOperationFeatures model.
 */
public class DiscoveryOperationFeaturesTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDiscoveryOperationFeatures() throws Throwable {
    DiscoveryOperationFeatures discoveryOperationFeaturesModel = new DiscoveryOperationFeatures();
    assertNull(discoveryOperationFeaturesModel.getTrafficStats());
  }
}
...
/**
 * Unit test class for the GetApiGatewayDiscoveryOptions model.
 */
public class GetApiGatewayDiscoveryOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetApiGatewayDiscoveryOptions() throws Throwable {
    GetApiGatewayDiscoveryOptions getApiGatewayDiscoveryOptionsModel = new GetApiGatewayDiscoveryOptions();
    assertNotNull(getApiGatewayDiscoveryOptionsModel);
  }
}
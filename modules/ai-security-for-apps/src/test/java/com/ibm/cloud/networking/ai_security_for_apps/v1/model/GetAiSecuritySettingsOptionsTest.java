...
/**
 * Unit test class for the GetAiSecuritySettingsOptions model.
 */
public class GetAiSecuritySettingsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAiSecuritySettingsOptions() throws Throwable {
    GetAiSecuritySettingsOptions getAiSecuritySettingsOptionsModel = new GetAiSecuritySettingsOptions();
    assertNotNull(getAiSecuritySettingsOptionsModel);
  }
}
...
/**
 * Unit test class for the UpdateZoneApiGatewayDiscoveryOperationOptions model.
 */
public class UpdateZoneApiGatewayDiscoveryOperationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateZoneApiGatewayDiscoveryOperationOptions() throws Throwable {
    UpdateZoneApiGatewayDiscoveryOperationOptions updateZoneApiGatewayDiscoveryOperationOptionsModel = new UpdateZoneApiGatewayDiscoveryOperationOptions.Builder()
      ...
      .build();
    assertEquals(updateZoneApiGatewayDiscoveryOperationOptionsModel.requestBody(), java.util.Collections.singletonMap("anyKey", "anyValue"));
  }
}
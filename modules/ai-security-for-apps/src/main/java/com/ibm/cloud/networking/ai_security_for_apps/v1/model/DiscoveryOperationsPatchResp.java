 ...
 */
public class DiscoveryOperationsPatchResp extends GenericModel {

  protected Boolean success;
  protected List<List<String>> errors;
  protected List<List<String>> messages;
  protected List<DiscoveryOperation> result;

  protected DiscoveryOperationsPatchResp() { }
   ...
   * @return the result
   */
  public List<DiscoveryOperation> getResult() {
    return result;
  }
}

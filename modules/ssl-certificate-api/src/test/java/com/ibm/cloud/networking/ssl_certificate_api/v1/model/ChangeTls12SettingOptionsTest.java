...
/**
 * Unit test class for the ChangeTls12SettingOptions model.
 */
public class ChangeTls12SettingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testChangeTls12SettingOptions() throws Throwable {
    ChangeTls12SettingOptions changeTls12SettingOptionsModel = new ChangeTls12SettingOptions.Builder()
      .value("on")
      .build();
    assertEquals(changeTls12SettingOptionsModel.value(), "on");
  }
}
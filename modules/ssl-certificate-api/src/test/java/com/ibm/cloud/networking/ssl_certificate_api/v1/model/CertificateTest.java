...
/**
 * Unit test class for the Certificate model.
 */
public class CertificateTest {
  ...
  @Test
  public void testCertificate() throws Throwable {
    Certificate certificateModel = new Certificate();
    assertNull(certificateModel.getId());
    assertNull(certificateModel.getHosts());
    assertNull(certificateModel.getStatus());
  }
}
...
/**
 * Unit test class for the ChangeTls13SettingOptions model.
 */
public class ChangeTls13SettingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testChangeTls13SettingOptions() throws Throwable {
    ChangeTls13SettingOptions changeTls13SettingOptionsModel = new ChangeTls13SettingOptions.Builder()
      .value("on")
      .build();
    assertEquals(changeTls13SettingOptionsModel.value(), "on");
  }
}
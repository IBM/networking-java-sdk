...
/**
 * Unit test class for the ChangeSslSettingOptions model.
 */
public class ChangeSslSettingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testChangeSslSettingOptions() throws Throwable {
    ChangeSslSettingOptions changeSslSettingOptionsModel = new ChangeSslSettingOptions.Builder()
      .value("off")
      .build();
    assertEquals(changeSslSettingOptionsModel.value(), "off");
  }
}
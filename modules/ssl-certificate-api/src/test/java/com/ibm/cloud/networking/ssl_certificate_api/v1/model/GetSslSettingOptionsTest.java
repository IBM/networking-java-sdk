...
/**
 * Unit test class for the GetSslSettingOptions model.
 */
public class GetSslSettingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetSslSettingOptions() throws Throwable {
    GetSslSettingOptions getSslSettingOptionsModel = new GetSslSettingOptions();
    assertNotNull(getSslSettingOptionsModel);
  }
}
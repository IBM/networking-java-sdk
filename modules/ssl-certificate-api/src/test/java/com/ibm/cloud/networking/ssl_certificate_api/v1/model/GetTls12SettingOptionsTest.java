...
/**
 * Unit test class for the GetTls12SettingOptions model.
 */
public class GetTls12SettingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetTls12SettingOptions() throws Throwable {
    GetTls12SettingOptions getTls12SettingOptionsModel = new GetTls12SettingOptions();
    assertNotNull(getTls12SettingOptionsModel);
  }
}
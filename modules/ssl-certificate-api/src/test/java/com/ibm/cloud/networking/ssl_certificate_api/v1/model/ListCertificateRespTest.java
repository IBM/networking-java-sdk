...
/**
 * Unit test class for the ListCertificateResp model.
 */
public class ListCertificateRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListCertificateResp() throws Throwable {
    ListCertificateResp listCertificateRespModel = new ListCertificateResp();
    assertNull(listCertificateRespModel.getResult());
    assertNull(listCertificateRespModel.getResultInfo());
    assertNull(listCertificateRespModel.isSuccess());
    assertNull(listCertificateRespModel.getErrors());
    assertNull(listCertificateRespModel.getMessages());
  }
}
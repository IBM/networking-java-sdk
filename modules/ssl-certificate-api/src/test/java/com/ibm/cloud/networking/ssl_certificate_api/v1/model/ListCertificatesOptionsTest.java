...
/**
 * Unit test class for the ListCertificatesOptions model.
 */
public class ListCertificatesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListCertificatesOptions() throws Throwable {
    ListCertificatesOptions listCertificatesOptionsModel = new ListCertificatesOptions.Builder()
      .xCorrelationId("testString")
      .build();
    assertEquals(listCertificatesOptionsModel.xCorrelationId(), "testString");
  }
}
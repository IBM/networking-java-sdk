...
/**
 * Unit test class for the Tls13SettingResp model.
 */
public class Tls13SettingRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testTls13SettingResp() throws Throwable {
    Tls13SettingResp tls13SettingRespModel = new Tls13SettingResp();
    assertNull(tls13SettingRespModel.getResult());
    assertNull(tls13SettingRespModel.isSuccess());
    assertNull(tls13SettingRespModel.getErrors());
    assertNull(tls13SettingRespModel.getMessages());
  }
}
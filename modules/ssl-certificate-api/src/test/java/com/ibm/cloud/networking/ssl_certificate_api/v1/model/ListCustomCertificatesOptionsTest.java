...
/**
 * Unit test class for the ListCustomCertificatesOptions model.
 */
public class ListCustomCertificatesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListCustomCertificatesOptions() throws Throwable {
    ListCustomCertificatesOptions listCustomCertificatesOptionsModel = new ListCustomCertificatesOptions();
    assertNotNull(listCustomCertificatesOptionsModel);
  }
}
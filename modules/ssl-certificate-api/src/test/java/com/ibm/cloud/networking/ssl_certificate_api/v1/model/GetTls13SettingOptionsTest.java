...
/**
 * Unit test class for the GetTls13SettingOptions model.
 */
public class GetTls13SettingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetTls13SettingOptions() throws Throwable {
    GetTls13SettingOptions getTls13SettingOptionsModel = new GetTls13SettingOptions();
    assertNotNull(getTls13SettingOptionsModel);
  }
}
...
/**
 * Unit test class for the ListCustomCertsResp model.
 */
public class ListCustomCertsRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListCustomCertsResp() throws Throwable {
    ListCustomCertsResp listCustomCertsRespModel = new ListCustomCertsResp();
    assertNull(listCustomCertsRespModel.getResult());
    assertNull(listCustomCertsRespModel.getResultInfo());
    assertNull(listCustomCertsRespModel.isSuccess());
    assertNull(listCustomCertsRespModel.getErrors());
    assertNull(listCustomCertsRespModel.getMessages());
  }
}
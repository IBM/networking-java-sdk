...
/**
 * Unit test class for the CustomCertResp model.
 */
public class CustomCertRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCustomCertResp() throws Throwable {
    CustomCertResp customCertRespModel = new CustomCertResp();
    assertNull(customCertRespModel.getResult());
    assertNull(customCertRespModel.isSuccess());
    assertNull(customCertRespModel.getErrors());
    assertNull(customCertRespModel.getMessages());
  }
}
...
/**
 * Unit test class for the GetUniversalCertificateSettingOptions model.
 */
public class GetUniversalCertificateSettingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetUniversalCertificateSettingOptions() throws Throwable {
    ...
    assertNotNull(getUniversalCertificateSettingOptionsModel);
  }
}
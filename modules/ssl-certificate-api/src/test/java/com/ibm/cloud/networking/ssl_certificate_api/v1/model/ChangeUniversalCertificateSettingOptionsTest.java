...
/**
 * Unit test class for the ChangeUniversalCertificateSettingOptions model.
 */
public class ChangeUniversalCertificateSettingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testChangeUniversalCertificateSettingOptions() throws Throwable {
    ChangeUniversalCertificateSettingOptions changeUniversalCertificateSettingOptionsModel = new ChangeUniversalCertificateSettingOptions.Builder()
      .enabled(true)
      .build();
    assertEquals(changeUniversalCertificateSettingOptionsModel.enabled(), Boolean.valueOf(true));
  }
}
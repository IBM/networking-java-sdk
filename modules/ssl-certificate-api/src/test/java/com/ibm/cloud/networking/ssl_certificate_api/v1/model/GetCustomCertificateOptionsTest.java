...
/**
 * Unit test class for the GetCustomCertificateOptions model.
 */
public class GetCustomCertificateOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetCustomCertificateOptions() throws Throwable {
    GetCustomCertificateOptions getCustomCertificateOptionsModel = new GetCustomCertificateOptions.Builder()
      ...
      .build();
    assertEquals(getCustomCertificateOptionsModel.customCertId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetCustomCertificateOptionsError() throws Throwable {
    new GetCustomCertificateOptions.Builder().build();
  }

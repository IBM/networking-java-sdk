 ...
 */
public class DeleteLoadBalancerPoolResp extends GenericModel {

  protected Boolean success;
  protected List<List<String>> errors;
  protected List<List<String>> messages;
  protected DeleteLoadBalancerPoolRespResult result;
   ...
   * @return the result
   */
  public DeleteLoadBalancerPoolRespResult getResult() {
    return result;
  }
}

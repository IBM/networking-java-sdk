...
/**
 * Unit test class for the DeleteLoadBalancerPoolOptions model.
 */
public class DeleteLoadBalancerPoolOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteLoadBalancerPoolOptions() throws Throwable {
    DeleteLoadBalancerPoolOptions deleteLoadBalancerPoolOptionsModel = new DeleteLoadBalancerPoolOptions.Builder()
      ...
      .build();
    assertEquals(deleteLoadBalancerPoolOptionsModel.poolIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteLoadBalancerPoolOptionsError() throws Throwable {
    new DeleteLoadBalancerPoolOptions.Builder().build();
  }

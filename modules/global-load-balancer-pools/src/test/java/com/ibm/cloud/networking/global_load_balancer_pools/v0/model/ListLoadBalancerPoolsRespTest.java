...
/**
 * Unit test class for the ListLoadBalancerPoolsResp model.
 */
public class ListLoadBalancerPoolsRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListLoadBalancerPoolsResp() throws Throwable {
    ListLoadBalancerPoolsResp listLoadBalancerPoolsRespModel = new ListLoadBalancerPoolsResp();
    assertNull(listLoadBalancerPoolsRespModel.isSuccess());
    assertNull(listLoadBalancerPoolsRespModel.getErrors());
    assertNull(listLoadBalancerPoolsRespModel.getMessages());
    assertNull(listLoadBalancerPoolsRespModel.getResult());
    assertNull(listLoadBalancerPoolsRespModel.getResultInfo());
  }
}
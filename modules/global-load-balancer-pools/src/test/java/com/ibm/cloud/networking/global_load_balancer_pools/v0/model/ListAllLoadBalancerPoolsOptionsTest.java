...
/**
 * Unit test class for the ListAllLoadBalancerPoolsOptions model.
 */
public class ListAllLoadBalancerPoolsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListAllLoadBalancerPoolsOptions() throws Throwable {
    ListAllLoadBalancerPoolsOptions listAllLoadBalancerPoolsOptionsModel = new ListAllLoadBalancerPoolsOptions();
    assertNotNull(listAllLoadBalancerPoolsOptionsModel);
  }
}
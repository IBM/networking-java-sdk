...
/**
 * Unit test class for the GetLoadBalancerPoolOptions model.
 */
public class GetLoadBalancerPoolOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetLoadBalancerPoolOptions() throws Throwable {
    GetLoadBalancerPoolOptions getLoadBalancerPoolOptionsModel = new GetLoadBalancerPoolOptions.Builder()
      ...
      .build();
    assertEquals(getLoadBalancerPoolOptionsModel.poolIdentifier(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetLoadBalancerPoolOptionsError() throws Throwable {
    new GetLoadBalancerPoolOptions.Builder().build();
  }

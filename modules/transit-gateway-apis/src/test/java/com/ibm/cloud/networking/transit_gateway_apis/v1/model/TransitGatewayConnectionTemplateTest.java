...
/**
 * Unit test class for the TransitGatewayConnectionTemplate model.
 */
public class TransitGatewayConnectionTemplateTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testTransitGatewayConnectionTemplate() throws Throwable {
    TransitGatewayConnectionTemplate transitGatewayConnectionTemplateModel = new TransitGatewayConnectionTemplate();
    assertNotNull(transitGatewayConnectionTemplateModel);
  }
}
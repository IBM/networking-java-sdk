...
public class ReplaceTransitGatewayConnectionPrefixFilterOptionsTest {
  ...
  public void testReplaceTransitGatewayConnectionPrefixFilterOptions() throws Throwable {
    ...
    assertEquals(replaceTransitGatewayConnectionPrefixFilterOptionsModel.prefixFilters(), new java.util.ArrayList<PrefixFilterPut>(java.util.Arrays.asList(prefixFilterPutModel)));
  }

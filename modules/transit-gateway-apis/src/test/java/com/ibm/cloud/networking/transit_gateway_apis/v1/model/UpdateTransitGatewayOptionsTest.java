...
/**
 * Unit test class for the UpdateTransitGatewayOptions model.
 */
public class UpdateTransitGatewayOptionsTest {
  ...
  public void testUpdateTransitGatewayOptions() throws Throwable {
    ...
    assertEquals(updateTransitGatewayOptionsModel.greEnhancedRoutePropagation(), Boolean.valueOf(true));
    assertEquals(updateTransitGatewayOptionsModel.name(), "my-resource");
    assertEquals(updateTransitGatewayOptionsModel.redundancyGroup(), "rg-1");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateTransitGatewayOptionsError() throws Throwable {
    new UpdateTransitGatewayOptions.Builder().build();
  }

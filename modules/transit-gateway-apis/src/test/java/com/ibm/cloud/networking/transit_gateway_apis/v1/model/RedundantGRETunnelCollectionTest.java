...
/**
 * Unit test class for the RedundantGRETunnelCollection model.
 */
public class RedundantGRETunnelCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testRedundantGRETunnelCollection() throws Throwable {
    RedundantGRETunnelCollection redundantGreTunnelCollectionModel = new RedundantGRETunnelCollection();
    assertNull(redundantGreTunnelCollectionModel.getTunnels());
  }
}
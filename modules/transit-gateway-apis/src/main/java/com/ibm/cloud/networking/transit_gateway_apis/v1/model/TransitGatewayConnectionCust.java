...
public class TransitGatewayConnectionCust extends GenericModel {
   ...
   * can be either VPC or Classic. This field is required to be unspecified for network type `classic`, `vmware`,
   ...
   * respectively. This field is required for network type `vpc`, `power_virtual_server`, `vmware`, `vpn_gateway`, and

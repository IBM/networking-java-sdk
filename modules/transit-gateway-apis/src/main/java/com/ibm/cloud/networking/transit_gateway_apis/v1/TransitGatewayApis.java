 ...
 * date may be provided. Specify the current date to request the latest version.
  ...
  public ServiceCall<TransitGateway> updateTransitGateway(UpdateTransitGatewayOptions updateTransitGatewayOptions) {
    ...
    if (updateTransitGatewayOptions.greEnhancedRoutePropagation() != null) {
      contentJson.addProperty("gre_enhanced_route_propagation", updateTransitGatewayOptions.greEnhancedRoutePropagation());
    }
  ...
  public ServiceCall<TransitConnectionCollection> listConnections(ListConnectionsOptions listConnectionsOptions) {
    ...
    if (listConnectionsOptions.networkType() != null) {
      builder.query("network_type", String.valueOf(listConnectionsOptions.networkType()));
    }
  ...
  public ServiceCall<RedundancyGroup> updateRedundancyGroup(UpdateRedundancyGroupOptions updateRedundancyGroupOptions) {
    ...
    builder.header("Accept", "application/json");
    builder.query("version", String.valueOf(this.version));
    builder.bodyContent(com.ibm.cloud.sdk.core.util.GsonSingleton.getGsonWithSerializeNulls().toJson(updateRedundancyGroupOptions.redundancyGroupPatch()), "application/merge-patch+json");
    ResponseConverter<RedundancyGroup> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<RedundancyGroup>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }

 ...
 */
public class TransitGatewayRedundantGRETunnelReference extends GenericModel {
  ...
  protected RgreTunnelZoneReference zone;

  protected TransitGatewayRedundantGRETunnelReference() { }
   ...
   * @return the zone
   */
  public RgreTunnelZoneReference getZone() {
    return zone;
  }
}

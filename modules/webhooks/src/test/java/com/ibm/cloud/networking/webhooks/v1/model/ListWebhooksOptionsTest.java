...
/**
 * Unit test class for the ListWebhooksOptions model.
 */
public class ListWebhooksOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListWebhooksOptions() throws Throwable {
    ListWebhooksOptions listWebhooksOptionsModel = new ListWebhooksOptions();
    assertNotNull(listWebhooksOptionsModel);
  }
}
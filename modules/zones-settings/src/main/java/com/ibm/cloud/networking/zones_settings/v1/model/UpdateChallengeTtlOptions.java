...
public class UpdateChallengeTtlOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateChallengeTtlOptions instance.
     *
     * @param updateChallengeTtlOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateChallengeTtlOptions() { }

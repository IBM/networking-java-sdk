...
public class UpdateMaxUploadOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateMaxUploadOptions instance.
     *
     * @param updateMaxUploadOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateMaxUploadOptions() { }

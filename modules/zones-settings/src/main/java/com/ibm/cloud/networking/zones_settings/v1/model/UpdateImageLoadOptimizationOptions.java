...
public class UpdateImageLoadOptimizationOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateImageLoadOptimizationOptions instance.
     *
     * @param updateImageLoadOptimizationOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateImageLoadOptimizationOptions() { }

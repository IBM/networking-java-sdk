 ...
 */
public class TlsClientAuthResp extends GenericModel {

  protected TlsClientAuthRespResult result;
  protected Boolean success;
  protected List<List<String>> errors;
  protected List<List<String>> messages;

  protected TlsClientAuthResp() { }
   ...
   * @return the result
   */
  public TlsClientAuthRespResult getResult() {
    return result;
  }

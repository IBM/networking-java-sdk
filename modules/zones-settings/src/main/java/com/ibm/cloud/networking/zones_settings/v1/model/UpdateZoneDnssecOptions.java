...
public class UpdateZoneDnssecOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateZoneDnssecOptions instance.
     *
     * @param updateZoneDnssecOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateZoneDnssecOptions() { }

...
public class UpdateEnableErrorPagesOnOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateEnableErrorPagesOnOptions instance.
     *
     * @param updateEnableErrorPagesOnOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateEnableErrorPagesOnOptions() { }

 ...
 */
public class ZonesCnameFlatteningResp extends GenericModel {

  protected Boolean success;
  protected List<List<String>> errors;
  protected List<List<String>> messages;
  protected CnameFlatteningResponse result;

  protected ZonesCnameFlatteningResp() { }
   ...
   * @return the result
   */
  public CnameFlatteningResponse getResult() {
    return result;
  }
}

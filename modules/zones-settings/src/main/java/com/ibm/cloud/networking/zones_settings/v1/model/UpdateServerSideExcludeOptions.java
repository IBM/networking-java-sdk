...
public class UpdateServerSideExcludeOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateServerSideExcludeOptions instance.
     *
     * @param updateServerSideExcludeOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateServerSideExcludeOptions() { }

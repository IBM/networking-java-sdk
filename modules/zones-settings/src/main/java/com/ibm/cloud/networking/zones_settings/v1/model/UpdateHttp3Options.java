...
public class UpdateHttp3Options extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateHttp3Options instance.
     *
     * @param updateHttp3Options the instance to initialize the Builder with
     */

...
public class UpdateBrowserCheckOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateBrowserCheckOptions instance.
     *
     * @param updateBrowserCheckOptions the instance to initialize the Builder with
     */
  ...
  protected UpdateBrowserCheckOptions() { }

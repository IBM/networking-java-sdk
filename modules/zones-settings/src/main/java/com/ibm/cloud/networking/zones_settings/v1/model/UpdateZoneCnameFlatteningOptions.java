...
public class UpdateZoneCnameFlatteningOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateZoneCnameFlatteningOptions instance.
     *
     * @param updateZoneCnameFlatteningOptions the instance to initialize the Builder with
     */

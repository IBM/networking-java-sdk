...
public class UpdateMinifyOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateMinifyOptions instance.
     *
     * @param updateMinifyOptions the instance to initialize the Builder with
     */

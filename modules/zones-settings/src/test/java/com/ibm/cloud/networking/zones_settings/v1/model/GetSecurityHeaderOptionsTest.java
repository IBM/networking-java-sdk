...
/**
 * Unit test class for the GetSecurityHeaderOptions model.
 */
public class GetSecurityHeaderOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetSecurityHeaderOptions() throws Throwable {
    GetSecurityHeaderOptions getSecurityHeaderOptionsModel = new GetSecurityHeaderOptions();
    assertNotNull(getSecurityHeaderOptionsModel);
  }
}
...
/**
 * Unit test class for the UpdateBrowserCheckOptions model.
 */
public class UpdateBrowserCheckOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateBrowserCheckOptions() throws Throwable {
    UpdateBrowserCheckOptions updateBrowserCheckOptionsModel = new UpdateBrowserCheckOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateBrowserCheckOptionsModel.value(), "true");
  }
}
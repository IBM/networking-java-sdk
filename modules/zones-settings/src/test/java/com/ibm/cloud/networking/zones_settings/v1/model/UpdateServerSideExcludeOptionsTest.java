...
/**
 * Unit test class for the UpdateServerSideExcludeOptions model.
 */
public class UpdateServerSideExcludeOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateServerSideExcludeOptions() throws Throwable {
    UpdateServerSideExcludeOptions updateServerSideExcludeOptionsModel = new UpdateServerSideExcludeOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateServerSideExcludeOptionsModel.value(), "true");
  }
}
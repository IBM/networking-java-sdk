...
/**
 * Unit test class for the SecurityHeaderResp model.
 */
public class SecurityHeaderRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testSecurityHeaderResp() throws Throwable {
    SecurityHeaderResp securityHeaderRespModel = new SecurityHeaderResp();
    assertNull(securityHeaderRespModel.getResult());
    assertNull(securityHeaderRespModel.isSuccess());
    assertNull(securityHeaderRespModel.getErrors());
    assertNull(securityHeaderRespModel.getMessages());
  }
}
...
/**
 * Unit test class for the UpdateOpportunisticOnionOptions model.
 */
public class UpdateOpportunisticOnionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateOpportunisticOnionOptions() throws Throwable {
    UpdateOpportunisticOnionOptions updateOpportunisticOnionOptionsModel = new UpdateOpportunisticOnionOptions.Builder()
      .value("off")
      .build();
    assertEquals(updateOpportunisticOnionOptionsModel.value(), "off");
  }
}
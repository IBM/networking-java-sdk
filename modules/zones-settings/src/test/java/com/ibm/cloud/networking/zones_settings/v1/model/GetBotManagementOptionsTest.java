...
/**
 * Unit test class for the GetBotManagementOptions model.
 */
public class GetBotManagementOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetBotManagementOptions() throws Throwable {
    GetBotManagementOptions getBotManagementOptionsModel = new GetBotManagementOptions();
    assertNotNull(getBotManagementOptionsModel);
  }
}
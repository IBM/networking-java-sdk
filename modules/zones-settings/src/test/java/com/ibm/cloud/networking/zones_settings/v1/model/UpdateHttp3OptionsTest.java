...
/**
 * Unit test class for the UpdateHttp3Options model.
 */
public class UpdateHttp3OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateHttp3Options() throws Throwable {
    UpdateHttp3Options updateHttp3OptionsModel = new UpdateHttp3Options.Builder()
      .value("on")
      .build();
    assertEquals(updateHttp3OptionsModel.value(), "on");
  }
}
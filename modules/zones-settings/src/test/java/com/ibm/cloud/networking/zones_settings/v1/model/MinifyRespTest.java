...
/**
 * Unit test class for the MinifyResp model.
 */
public class MinifyRespTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testMinifyResp() throws Throwable {
    MinifyResp minifyRespModel = new MinifyResp();
    assertNull(minifyRespModel.getResult());
    assertNull(minifyRespModel.isSuccess());
    assertNull(minifyRespModel.getErrors());
    assertNull(minifyRespModel.getMessages());
  }
}
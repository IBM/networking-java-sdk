...
/**
 * Unit test class for the GetHttp2Options model.
 */
public class GetHttp2OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetHttp2Options() throws Throwable {
    GetHttp2Options getHttp2OptionsModel = new GetHttp2Options();
    assertNotNull(getHttp2OptionsModel);
  }
}
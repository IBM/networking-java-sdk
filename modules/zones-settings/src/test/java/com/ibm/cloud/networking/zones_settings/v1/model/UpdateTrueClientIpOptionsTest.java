...
/**
 * Unit test class for the UpdateTrueClientIpOptions model.
 */
public class UpdateTrueClientIpOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateTrueClientIpOptions() throws Throwable {
    UpdateTrueClientIpOptions updateTrueClientIpOptionsModel = new UpdateTrueClientIpOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateTrueClientIpOptionsModel.value(), "true");
  }
}
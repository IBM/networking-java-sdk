...
/**
 * Unit test class for the GetImageLoadOptimizationOptions model.
 */
public class GetImageLoadOptimizationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetImageLoadOptimizationOptions() throws Throwable {
    GetImageLoadOptimizationOptions getImageLoadOptimizationOptionsModel = new GetImageLoadOptimizationOptions();
    assertNotNull(getImageLoadOptimizationOptionsModel);
  }
}
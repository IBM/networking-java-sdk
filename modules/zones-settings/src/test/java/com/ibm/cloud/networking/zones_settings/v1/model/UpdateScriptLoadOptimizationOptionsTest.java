...
/**
 * Unit test class for the UpdateScriptLoadOptimizationOptions model.
 */
public class UpdateScriptLoadOptimizationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateScriptLoadOptimizationOptions() throws Throwable {
    UpdateScriptLoadOptimizationOptions updateScriptLoadOptimizationOptionsModel = new UpdateScriptLoadOptimizationOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateScriptLoadOptimizationOptionsModel.value(), "true");
  }
}
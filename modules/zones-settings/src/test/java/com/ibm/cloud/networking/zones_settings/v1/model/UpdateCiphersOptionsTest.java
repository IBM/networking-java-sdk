...
/**
 * Unit test class for the UpdateCiphersOptions model.
 */
public class UpdateCiphersOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateCiphersOptions() throws Throwable {
    UpdateCiphersOptions updateCiphersOptionsModel = new UpdateCiphersOptions.Builder()
      ...
      .build();
    assertEquals(updateCiphersOptionsModel.value(), new java.util.ArrayList<String>(java.util.Arrays.asList("ECDHE-ECDSA-AES128-GCM-SHA256")));
  }
}
...
/**
 * Unit test class for the UpdateZoneCnameFlatteningOptions model.
 */
public class UpdateZoneCnameFlatteningOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateZoneCnameFlatteningOptions() throws Throwable {
    UpdateZoneCnameFlatteningOptions updateZoneCnameFlatteningOptionsModel = new UpdateZoneCnameFlatteningOptions.Builder()
      .value("flatten_all")
      .build();
    assertEquals(updateZoneCnameFlatteningOptionsModel.value(), "flatten_all");
  }
}
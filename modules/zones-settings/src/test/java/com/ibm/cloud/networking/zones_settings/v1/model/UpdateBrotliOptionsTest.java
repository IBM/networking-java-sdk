...
/**
 * Unit test class for the UpdateBrotliOptions model.
 */
public class UpdateBrotliOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateBrotliOptions() throws Throwable {
    UpdateBrotliOptions updateBrotliOptionsModel = new UpdateBrotliOptions.Builder()
      .value("on")
      .build();
    assertEquals(updateBrotliOptionsModel.value(), "on");
  }
}
...
/**
 * Unit test class for the UpdatePseudoIpv4Options model.
 */
public class UpdatePseudoIpv4OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdatePseudoIpv4Options() throws Throwable {
    UpdatePseudoIpv4Options updatePseudoIpv4OptionsModel = new UpdatePseudoIpv4Options.Builder()
      .value("add_header")
      .build();
    assertEquals(updatePseudoIpv4OptionsModel.value(), "add_header");
  }
}
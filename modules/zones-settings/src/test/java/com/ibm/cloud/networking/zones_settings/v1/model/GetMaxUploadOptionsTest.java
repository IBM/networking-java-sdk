...
/**
 * Unit test class for the GetMaxUploadOptions model.
 */
public class GetMaxUploadOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetMaxUploadOptions() throws Throwable {
    GetMaxUploadOptions getMaxUploadOptionsModel = new GetMaxUploadOptions();
    assertNotNull(getMaxUploadOptionsModel);
  }
}
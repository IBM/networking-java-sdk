...
/**
 * Unit test class for the GetMinifyOptions model.
 */
public class GetMinifyOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetMinifyOptions() throws Throwable {
    GetMinifyOptions getMinifyOptionsModel = new GetMinifyOptions();
    assertNotNull(getMinifyOptionsModel);
  }
}
...
/**
 * Unit test class for the UpdateHttp2Options model.
 */
public class UpdateHttp2OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateHttp2Options() throws Throwable {
    UpdateHttp2Options updateHttp2OptionsModel = new UpdateHttp2Options.Builder()
      .value("true")
      .build();
    assertEquals(updateHttp2OptionsModel.value(), "true");
  }
}
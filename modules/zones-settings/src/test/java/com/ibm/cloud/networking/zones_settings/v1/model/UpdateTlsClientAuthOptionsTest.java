...
/**
 * Unit test class for the UpdateTlsClientAuthOptions model.
 */
public class UpdateTlsClientAuthOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateTlsClientAuthOptions() throws Throwable {
    UpdateTlsClientAuthOptions updateTlsClientAuthOptionsModel = new UpdateTlsClientAuthOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateTlsClientAuthOptionsModel.value(), "true");
  }
}
...
/**
 * Unit test class for the GetChallengeTtlOptions model.
 */
public class GetChallengeTtlOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetChallengeTtlOptions() throws Throwable {
    GetChallengeTtlOptions getChallengeTtlOptionsModel = new GetChallengeTtlOptions();
    assertNotNull(getChallengeTtlOptionsModel);
  }
}
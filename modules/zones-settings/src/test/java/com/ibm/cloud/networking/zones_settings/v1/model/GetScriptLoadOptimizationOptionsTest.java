...
/**
 * Unit test class for the GetScriptLoadOptimizationOptions model.
 */
public class GetScriptLoadOptimizationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetScriptLoadOptimizationOptions() throws Throwable {
    GetScriptLoadOptimizationOptions getScriptLoadOptimizationOptionsModel = new GetScriptLoadOptimizationOptions();
    assertNotNull(getScriptLoadOptimizationOptionsModel);
  }
}
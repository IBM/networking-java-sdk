...
/**
 * Unit test class for the UpdateOriginPostQuantumEncryptionOptions model.
 */
public class UpdateOriginPostQuantumEncryptionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateOriginPostQuantumEncryptionOptions() throws Throwable {
    UpdateOriginPostQuantumEncryptionOptions updateOriginPostQuantumEncryptionOptionsModel = new UpdateOriginPostQuantumEncryptionOptions.Builder()
      .value("preferred")
      .build();
    assertEquals(updateOriginPostQuantumEncryptionOptionsModel.value(), "preferred");
  }
}
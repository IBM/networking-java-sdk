...
/**
 * Unit test class for the GetResponseBufferingOptions model.
 */
public class GetResponseBufferingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetResponseBufferingOptions() throws Throwable {
    GetResponseBufferingOptions getResponseBufferingOptionsModel = new GetResponseBufferingOptions();
    assertNotNull(getResponseBufferingOptionsModel);
  }
}
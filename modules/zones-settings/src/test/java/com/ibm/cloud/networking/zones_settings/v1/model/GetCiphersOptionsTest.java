...
/**
 * Unit test class for the GetCiphersOptions model.
 */
public class GetCiphersOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetCiphersOptions() throws Throwable {
    GetCiphersOptions getCiphersOptionsModel = new GetCiphersOptions();
    assertNotNull(getCiphersOptionsModel);
  }
}
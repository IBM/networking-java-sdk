...
/**
 * Unit test class for the GetSecurityLevelOptions model.
 */
public class GetSecurityLevelOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetSecurityLevelOptions() throws Throwable {
    GetSecurityLevelOptions getSecurityLevelOptionsModel = new GetSecurityLevelOptions();
    assertNotNull(getSecurityLevelOptionsModel);
  }
}
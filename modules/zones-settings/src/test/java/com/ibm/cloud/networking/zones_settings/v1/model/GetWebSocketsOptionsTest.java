...
/**
 * Unit test class for the GetWebSocketsOptions model.
 */
public class GetWebSocketsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetWebSocketsOptions() throws Throwable {
    GetWebSocketsOptions getWebSocketsOptionsModel = new GetWebSocketsOptions();
    assertNotNull(getWebSocketsOptionsModel);
  }
}
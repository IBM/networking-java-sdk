...
/**
 * Unit test class for the GetZoneCnameFlatteningOptions model.
 */
public class GetZoneCnameFlatteningOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetZoneCnameFlatteningOptions() throws Throwable {
    GetZoneCnameFlatteningOptions getZoneCnameFlatteningOptionsModel = new GetZoneCnameFlatteningOptions();
    assertNotNull(getZoneCnameFlatteningOptionsModel);
  }
}
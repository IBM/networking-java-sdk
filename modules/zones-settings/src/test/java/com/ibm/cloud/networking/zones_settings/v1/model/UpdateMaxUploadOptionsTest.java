...
/**
 * Unit test class for the UpdateMaxUploadOptions model.
 */
public class UpdateMaxUploadOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateMaxUploadOptions() throws Throwable {
    UpdateMaxUploadOptions updateMaxUploadOptionsModel = new UpdateMaxUploadOptions.Builder()
      .value(Long.valueOf("300"))
      .build();
    assertEquals(updateMaxUploadOptionsModel.value(), Long.valueOf("300"));
  }
}
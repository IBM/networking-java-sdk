...
/**
 * Unit test class for the GetIpv6Options model.
 */
public class GetIpv6OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetIpv6Options() throws Throwable {
    GetIpv6Options getIpv6OptionsModel = new GetIpv6Options();
    assertNotNull(getIpv6OptionsModel);
  }
}
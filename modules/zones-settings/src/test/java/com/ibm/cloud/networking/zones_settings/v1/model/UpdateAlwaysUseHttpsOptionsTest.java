...
/**
 * Unit test class for the UpdateAlwaysUseHttpsOptions model.
 */
public class UpdateAlwaysUseHttpsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateAlwaysUseHttpsOptions() throws Throwable {
    UpdateAlwaysUseHttpsOptions updateAlwaysUseHttpsOptionsModel = new UpdateAlwaysUseHttpsOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateAlwaysUseHttpsOptionsModel.value(), "true");
  }
}
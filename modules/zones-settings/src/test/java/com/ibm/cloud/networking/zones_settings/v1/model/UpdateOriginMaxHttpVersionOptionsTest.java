...
/**
 * Unit test class for the UpdateOriginMaxHttpVersionOptions model.
 */
public class UpdateOriginMaxHttpVersionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateOriginMaxHttpVersionOptions() throws Throwable {
    UpdateOriginMaxHttpVersionOptions updateOriginMaxHttpVersionOptionsModel = new UpdateOriginMaxHttpVersionOptions.Builder()
      .value("1")
      .build();
    assertEquals(updateOriginMaxHttpVersionOptionsModel.value(), "1");
  }
}
...
/**
 * Unit test class for the UpdateImageSizeOptimizationOptions model.
 */
public class UpdateImageSizeOptimizationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateImageSizeOptimizationOptions() throws Throwable {
    UpdateImageSizeOptimizationOptions updateImageSizeOptimizationOptionsModel = new UpdateImageSizeOptimizationOptions.Builder()
      .value("lossless")
      .build();
    assertEquals(updateImageSizeOptimizationOptionsModel.value(), "lossless");
  }
}
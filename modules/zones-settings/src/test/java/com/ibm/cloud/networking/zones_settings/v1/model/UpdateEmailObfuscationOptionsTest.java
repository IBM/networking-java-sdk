...
/**
 * Unit test class for the UpdateEmailObfuscationOptions model.
 */
public class UpdateEmailObfuscationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateEmailObfuscationOptions() throws Throwable {
    UpdateEmailObfuscationOptions updateEmailObfuscationOptionsModel = new UpdateEmailObfuscationOptions.Builder()
      .value("off")
      .build();
    assertEquals(updateEmailObfuscationOptionsModel.value(), "off");
  }
}
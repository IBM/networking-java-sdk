...
/**
 * Unit test class for the UpdateReplaceInsecureJsOptions model.
 */
public class UpdateReplaceInsecureJsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateReplaceInsecureJsOptions() throws Throwable {
    UpdateReplaceInsecureJsOptions updateReplaceInsecureJsOptionsModel = new UpdateReplaceInsecureJsOptions.Builder()
      .value("off")
      .build();
    assertEquals(updateReplaceInsecureJsOptionsModel.value(), "off");
  }
}
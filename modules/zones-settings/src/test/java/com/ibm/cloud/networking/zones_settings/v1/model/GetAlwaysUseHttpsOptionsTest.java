...
/**
 * Unit test class for the GetAlwaysUseHttpsOptions model.
 */
public class GetAlwaysUseHttpsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAlwaysUseHttpsOptions() throws Throwable {
    GetAlwaysUseHttpsOptions getAlwaysUseHttpsOptionsModel = new GetAlwaysUseHttpsOptions();
    assertNotNull(getAlwaysUseHttpsOptionsModel);
  }
}
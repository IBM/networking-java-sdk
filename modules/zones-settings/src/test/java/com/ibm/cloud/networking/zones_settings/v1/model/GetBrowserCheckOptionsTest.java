...
/**
 * Unit test class for the GetBrowserCheckOptions model.
 */
public class GetBrowserCheckOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetBrowserCheckOptions() throws Throwable {
    GetBrowserCheckOptions getBrowserCheckOptionsModel = new GetBrowserCheckOptions();
    assertNotNull(getBrowserCheckOptionsModel);
  }
}
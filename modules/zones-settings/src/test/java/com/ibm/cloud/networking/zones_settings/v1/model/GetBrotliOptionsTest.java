...
/**
 * Unit test class for the GetBrotliOptions model.
 */
public class GetBrotliOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetBrotliOptions() throws Throwable {
    GetBrotliOptions getBrotliOptionsModel = new GetBrotliOptions();
    assertNotNull(getBrotliOptionsModel);
  }
}
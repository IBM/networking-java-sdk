...
/**
 * Unit test class for the GetIpGeolocationOptions model.
 */
public class GetIpGeolocationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetIpGeolocationOptions() throws Throwable {
    GetIpGeolocationOptions getIpGeolocationOptionsModel = new GetIpGeolocationOptions();
    assertNotNull(getIpGeolocationOptionsModel);
  }
}
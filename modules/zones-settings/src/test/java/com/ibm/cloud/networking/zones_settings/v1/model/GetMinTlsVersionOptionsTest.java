...
/**
 * Unit test class for the GetMinTlsVersionOptions model.
 */
public class GetMinTlsVersionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetMinTlsVersionOptions() throws Throwable {
    GetMinTlsVersionOptions getMinTlsVersionOptionsModel = new GetMinTlsVersionOptions();
    assertNotNull(getMinTlsVersionOptionsModel);
  }
}
...
/**
 * Unit test class for the GetZoneDnssecOptions model.
 */
public class GetZoneDnssecOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetZoneDnssecOptions() throws Throwable {
    GetZoneDnssecOptions getZoneDnssecOptionsModel = new GetZoneDnssecOptions();
    assertNotNull(getZoneDnssecOptionsModel);
  }
}
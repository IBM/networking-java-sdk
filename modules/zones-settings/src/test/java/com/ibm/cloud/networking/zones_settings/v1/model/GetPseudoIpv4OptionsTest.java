...
/**
 * Unit test class for the GetPseudoIpv4Options model.
 */
public class GetPseudoIpv4OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetPseudoIpv4Options() throws Throwable {
    GetPseudoIpv4Options getPseudoIpv4OptionsModel = new GetPseudoIpv4Options();
    assertNotNull(getPseudoIpv4OptionsModel);
  }
}
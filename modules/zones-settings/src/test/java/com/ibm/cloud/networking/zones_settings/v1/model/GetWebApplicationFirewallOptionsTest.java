...
/**
 * Unit test class for the GetWebApplicationFirewallOptions model.
 */
public class GetWebApplicationFirewallOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetWebApplicationFirewallOptions() throws Throwable {
    GetWebApplicationFirewallOptions getWebApplicationFirewallOptionsModel = new GetWebApplicationFirewallOptions();
    assertNotNull(getWebApplicationFirewallOptionsModel);
  }
}
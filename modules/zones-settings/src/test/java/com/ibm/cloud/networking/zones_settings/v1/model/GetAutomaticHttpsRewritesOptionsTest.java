...
/**
 * Unit test class for the GetAutomaticHttpsRewritesOptions model.
 */
public class GetAutomaticHttpsRewritesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAutomaticHttpsRewritesOptions() throws Throwable {
    GetAutomaticHttpsRewritesOptions getAutomaticHttpsRewritesOptionsModel = new GetAutomaticHttpsRewritesOptions();
    assertNotNull(getAutomaticHttpsRewritesOptionsModel);
  }
}
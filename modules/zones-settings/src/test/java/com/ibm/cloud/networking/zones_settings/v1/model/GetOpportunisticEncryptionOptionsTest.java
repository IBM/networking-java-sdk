...
/**
 * Unit test class for the GetOpportunisticEncryptionOptions model.
 */
public class GetOpportunisticEncryptionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetOpportunisticEncryptionOptions() throws Throwable {
    GetOpportunisticEncryptionOptions getOpportunisticEncryptionOptionsModel = new GetOpportunisticEncryptionOptions();
    assertNotNull(getOpportunisticEncryptionOptionsModel);
  }
}
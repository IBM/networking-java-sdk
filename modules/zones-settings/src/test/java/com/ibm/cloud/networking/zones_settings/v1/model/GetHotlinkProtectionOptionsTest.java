...
/**
 * Unit test class for the GetHotlinkProtectionOptions model.
 */
public class GetHotlinkProtectionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetHotlinkProtectionOptions() throws Throwable {
    GetHotlinkProtectionOptions getHotlinkProtectionOptionsModel = new GetHotlinkProtectionOptions();
    assertNotNull(getHotlinkProtectionOptionsModel);
  }
}
...
/**
 * Unit test class for the UpdateSecurityHeaderOptions model.
 */
public class UpdateSecurityHeaderOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateSecurityHeaderOptions() throws Throwable {
    ...
    UpdateSecurityHeaderOptions updateSecurityHeaderOptionsModel = new UpdateSecurityHeaderOptions.Builder()
      ...
      .build();
    assertEquals(updateSecurityHeaderOptionsModel.value(), securityHeaderSettingValueModel);
  }
}
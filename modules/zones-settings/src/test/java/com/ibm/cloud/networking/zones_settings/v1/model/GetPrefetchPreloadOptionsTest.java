...
/**
 * Unit test class for the GetPrefetchPreloadOptions model.
 */
public class GetPrefetchPreloadOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetPrefetchPreloadOptions() throws Throwable {
    GetPrefetchPreloadOptions getPrefetchPreloadOptionsModel = new GetPrefetchPreloadOptions();
    assertNotNull(getPrefetchPreloadOptionsModel);
  }
}
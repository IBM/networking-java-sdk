...
/**
 * Unit test class for the GetImageSizeOptimizationOptions model.
 */
public class GetImageSizeOptimizationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetImageSizeOptimizationOptions() throws Throwable {
    GetImageSizeOptimizationOptions getImageSizeOptimizationOptionsModel = new GetImageSizeOptimizationOptions();
    assertNotNull(getImageSizeOptimizationOptionsModel);
  }
}
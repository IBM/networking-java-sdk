...
/**
 * Unit test class for the UpdateAutomaticHttpsRewritesOptions model.
 */
public class UpdateAutomaticHttpsRewritesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateAutomaticHttpsRewritesOptions() throws Throwable {
    UpdateAutomaticHttpsRewritesOptions updateAutomaticHttpsRewritesOptionsModel = new UpdateAutomaticHttpsRewritesOptions.Builder()
      .value("false")
      .build();
    assertEquals(updateAutomaticHttpsRewritesOptionsModel.value(), "false");
  }
}
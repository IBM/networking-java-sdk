...
/**
 * Unit test class for the GetOriginMaxHttpVersionOptions model.
 */
public class GetOriginMaxHttpVersionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetOriginMaxHttpVersionOptions() throws Throwable {
    GetOriginMaxHttpVersionOptions getOriginMaxHttpVersionOptionsModel = new GetOriginMaxHttpVersionOptions();
    assertNotNull(getOriginMaxHttpVersionOptionsModel);
  }
}
...
/**
 * Unit test class for the GetTrueClientIpOptions model.
 */
public class GetTrueClientIpOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetTrueClientIpOptions() throws Throwable {
    GetTrueClientIpOptions getTrueClientIpOptionsModel = new GetTrueClientIpOptions();
    assertNotNull(getTrueClientIpOptionsModel);
  }
}
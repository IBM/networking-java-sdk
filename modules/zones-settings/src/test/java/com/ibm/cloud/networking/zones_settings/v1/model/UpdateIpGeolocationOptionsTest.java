...
/**
 * Unit test class for the UpdateIpGeolocationOptions model.
 */
public class UpdateIpGeolocationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateIpGeolocationOptions() throws Throwable {
    UpdateIpGeolocationOptions updateIpGeolocationOptionsModel = new UpdateIpGeolocationOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateIpGeolocationOptionsModel.value(), "true");
  }
}
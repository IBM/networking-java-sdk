...
/**
 * Unit test class for the UpdateMinTlsVersionOptions model.
 */
public class UpdateMinTlsVersionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateMinTlsVersionOptions() throws Throwable {
    UpdateMinTlsVersionOptions updateMinTlsVersionOptionsModel = new UpdateMinTlsVersionOptions.Builder()
      .value("1.2")
      .build();
    assertEquals(updateMinTlsVersionOptionsModel.value(), "1.2");
  }
}
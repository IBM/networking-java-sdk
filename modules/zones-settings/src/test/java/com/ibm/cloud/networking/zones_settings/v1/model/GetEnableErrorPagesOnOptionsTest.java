...
/**
 * Unit test class for the GetEnableErrorPagesOnOptions model.
 */
public class GetEnableErrorPagesOnOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetEnableErrorPagesOnOptions() throws Throwable {
    GetEnableErrorPagesOnOptions getEnableErrorPagesOnOptionsModel = new GetEnableErrorPagesOnOptions();
    assertNotNull(getEnableErrorPagesOnOptionsModel);
  }
}
...
/**
 * Unit test class for the UpdateSecurityLevelOptions model.
 */
public class UpdateSecurityLevelOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateSecurityLevelOptions() throws Throwable {
    UpdateSecurityLevelOptions updateSecurityLevelOptionsModel = new UpdateSecurityLevelOptions.Builder()
      .value("medium")
      .build();
    assertEquals(updateSecurityLevelOptionsModel.value(), "medium");
  }
}
...
/**
 * Unit test class for the UpdateResponseBufferingOptions model.
 */
public class UpdateResponseBufferingOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateResponseBufferingOptions() throws Throwable {
    UpdateResponseBufferingOptions updateResponseBufferingOptionsModel = new UpdateResponseBufferingOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateResponseBufferingOptionsModel.value(), "true");
  }
}
...
/**
 * Unit test class for the GetOriginPostQuantumEncryptionOptions model.
 */
public class GetOriginPostQuantumEncryptionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetOriginPostQuantumEncryptionOptions() throws Throwable {

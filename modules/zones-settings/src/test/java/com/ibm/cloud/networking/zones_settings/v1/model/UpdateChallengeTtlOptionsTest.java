...
/**
 * Unit test class for the UpdateChallengeTtlOptions model.
 */
public class UpdateChallengeTtlOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateChallengeTtlOptions() throws Throwable {
    UpdateChallengeTtlOptions updateChallengeTtlOptionsModel = new UpdateChallengeTtlOptions.Builder()
      .value(Long.valueOf("1800"))
      .build();
    assertEquals(updateChallengeTtlOptionsModel.value(), Long.valueOf("1800"));
  }
}
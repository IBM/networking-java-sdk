...
/**
 * Unit test class for the UpdateZoneDnssecOptions model.
 */
public class UpdateZoneDnssecOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateZoneDnssecOptions() throws Throwable {
    UpdateZoneDnssecOptions updateZoneDnssecOptionsModel = new UpdateZoneDnssecOptions.Builder()
      .status("active")
      .build();
    assertEquals(updateZoneDnssecOptionsModel.status(), "active");
  }
}
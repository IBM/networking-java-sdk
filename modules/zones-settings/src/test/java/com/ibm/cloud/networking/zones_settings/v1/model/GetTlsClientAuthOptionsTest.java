...
/**
 * Unit test class for the GetTlsClientAuthOptions model.
 */
public class GetTlsClientAuthOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetTlsClientAuthOptions() throws Throwable {
    GetTlsClientAuthOptions getTlsClientAuthOptionsModel = new GetTlsClientAuthOptions();
    assertNotNull(getTlsClientAuthOptionsModel);
  }
}
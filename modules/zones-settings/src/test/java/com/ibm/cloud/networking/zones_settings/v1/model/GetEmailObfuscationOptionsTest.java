...
/**
 * Unit test class for the GetEmailObfuscationOptions model.
 */
public class GetEmailObfuscationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetEmailObfuscationOptions() throws Throwable {
    GetEmailObfuscationOptions getEmailObfuscationOptionsModel = new GetEmailObfuscationOptions();
    assertNotNull(getEmailObfuscationOptionsModel);
  }
}
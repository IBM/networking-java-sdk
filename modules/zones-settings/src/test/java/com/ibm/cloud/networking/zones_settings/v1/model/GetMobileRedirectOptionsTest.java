...
/**
 * Unit test class for the GetMobileRedirectOptions model.
 */
public class GetMobileRedirectOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetMobileRedirectOptions() throws Throwable {
    GetMobileRedirectOptions getMobileRedirectOptionsModel = new GetMobileRedirectOptions();
    assertNotNull(getMobileRedirectOptionsModel);
  }
}
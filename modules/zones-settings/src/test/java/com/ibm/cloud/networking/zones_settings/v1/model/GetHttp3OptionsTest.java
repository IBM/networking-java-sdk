...
/**
 * Unit test class for the GetHttp3Options model.
 */
public class GetHttp3OptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetHttp3Options() throws Throwable {
    GetHttp3Options getHttp3OptionsModel = new GetHttp3Options();
    assertNotNull(getHttp3OptionsModel);
  }
}
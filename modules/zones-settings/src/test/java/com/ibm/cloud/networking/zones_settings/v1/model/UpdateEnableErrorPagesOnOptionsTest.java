...
/**
 * Unit test class for the UpdateEnableErrorPagesOnOptions model.
 */
public class UpdateEnableErrorPagesOnOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateEnableErrorPagesOnOptions() throws Throwable {
    UpdateEnableErrorPagesOnOptions updateEnableErrorPagesOnOptionsModel = new UpdateEnableErrorPagesOnOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateEnableErrorPagesOnOptionsModel.value(), "true");
  }
}
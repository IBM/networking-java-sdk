...
/**
 * Unit test class for the UpdateHotlinkProtectionOptions model.
 */
public class UpdateHotlinkProtectionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateHotlinkProtectionOptions() throws Throwable {
    UpdateHotlinkProtectionOptions updateHotlinkProtectionOptionsModel = new UpdateHotlinkProtectionOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateHotlinkProtectionOptionsModel.value(), "true");
  }
}
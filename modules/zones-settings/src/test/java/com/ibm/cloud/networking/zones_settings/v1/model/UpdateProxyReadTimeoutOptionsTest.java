...
/**
 * Unit test class for the UpdateProxyReadTimeoutOptions model.
 */
public class UpdateProxyReadTimeoutOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateProxyReadTimeoutOptions() throws Throwable {
    UpdateProxyReadTimeoutOptions updateProxyReadTimeoutOptionsModel = new UpdateProxyReadTimeoutOptions.Builder()
      ...
      .build();
    assertEquals(updateProxyReadTimeoutOptionsModel.value(), Double.valueOf("600"));
  }
}
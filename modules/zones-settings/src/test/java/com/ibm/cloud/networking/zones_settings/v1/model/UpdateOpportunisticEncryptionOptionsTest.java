...
/**
 * Unit test class for the UpdateOpportunisticEncryptionOptions model.
 */
public class UpdateOpportunisticEncryptionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateOpportunisticEncryptionOptions() throws Throwable {
    UpdateOpportunisticEncryptionOptions updateOpportunisticEncryptionOptionsModel = new UpdateOpportunisticEncryptionOptions.Builder()
      .value("false")
      .build();
    assertEquals(updateOpportunisticEncryptionOptionsModel.value(), "false");
  }
}
...
/**
 * Unit test class for the UpdateMinifyOptions model.
 */
public class UpdateMinifyOptionsTest {
  ...
  public void testUpdateMinifyOptions() throws Throwable {
    ...
    UpdateMinifyOptions updateMinifyOptionsModel = new UpdateMinifyOptions.Builder()
      ...
      .build();
    assertEquals(updateMinifyOptionsModel.value(), minifySettingValueModel);
  }
}
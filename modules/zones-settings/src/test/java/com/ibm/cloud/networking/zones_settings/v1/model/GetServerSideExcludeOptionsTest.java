...
/**
 * Unit test class for the GetServerSideExcludeOptions model.
 */
public class GetServerSideExcludeOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetServerSideExcludeOptions() throws Throwable {
    GetServerSideExcludeOptions getServerSideExcludeOptionsModel = new GetServerSideExcludeOptions();
    assertNotNull(getServerSideExcludeOptionsModel);
  }
}
...
/**
 * Unit test class for the UpdateWebSocketsOptions model.
 */
public class UpdateWebSocketsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateWebSocketsOptions() throws Throwable {
    UpdateWebSocketsOptions updateWebSocketsOptionsModel = new UpdateWebSocketsOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateWebSocketsOptionsModel.value(), "true");
  }
}
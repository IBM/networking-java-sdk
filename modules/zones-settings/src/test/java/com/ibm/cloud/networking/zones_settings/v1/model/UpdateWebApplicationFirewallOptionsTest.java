...
/**
 * Unit test class for the UpdateWebApplicationFirewallOptions model.
 */
public class UpdateWebApplicationFirewallOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateWebApplicationFirewallOptions() throws Throwable {
    UpdateWebApplicationFirewallOptions updateWebApplicationFirewallOptionsModel = new UpdateWebApplicationFirewallOptions.Builder()
      .value("true")
      .build();
    assertEquals(updateWebApplicationFirewallOptionsModel.value(), "true");
  }
}
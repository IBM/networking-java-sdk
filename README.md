...
# IBM Cloud Networking Services Java SDK Version 0.0.1
...
--- | --- 
[Transit Gateway ](https://cloud.ibm.com/docs/transit-gateway) | com.ibm.cloud:transit-gateway-apis:0.0.1
[Direct Link](https://cloud.ibm.com/apidocs/direct_link) | com.ibm.cloud:direct-link-apis:0.0.1
## Prerequisites

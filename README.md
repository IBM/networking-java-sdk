...
# IBM Cloud Networking Services Java SDK Version 0.5.1
...
--- | --- 
[Transit Gateway ](https://cloud.ibm.com/docs/transit-gateway) | com.ibm.cloud:transit-gateway-apis:0.5.1
[Direct Link](https://cloud.ibm.com/apidocs/direct_link) | com.ibm.cloud:direct-link-apis:0.5.1
## Prerequisites
...
## Installation
The current version of this SDK is: 0.5.1

...
rm -fr ./gh-pages
git config --global user.email "devx.network.services@us.ibm.com"
git config --global user.name "DevxNetworkServices"
git clone --branch=gh-pages https://${GH_TOKEN}@github.com/${GH_REPO_SLUG}.git gh-pages
